...
<?php           $course_sql="SELECT * 
                             ...
                             WHERE `tb_course_detail`.`course_detail_id`='{$course_key}'
                ...
                <option value="<?php echo $course_row["course_detail_id"];?>"> <?php echo $course_row["course_name"]." (".$course_row["course_name_en"].") ".$date_course_start." - ".$date_course_finnish;?> </option> 
