              ...
              <div class="col-md-12">
                <div class="page-body">
                  <div class="container-xl">
                    <div class="row row-cards">
                      <div class="col-md-12">
<form name="form_verify_registration" action="#" method="post" class="card" charset="utf-8">
                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="page-header d=print-none">
                                      <div class="container-xl">
                                        <div class="row g-2 alogn-items-center">
                                          <div col-md-12>
                                            <div class="page-title" style="font-size: 20px;">ตรวจสอบสิทธิ์</div>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                            ...
                            <div class="row g-5">                        
                              <div class="col-md-12">
                                <div class="card-footer text-end" style="margin: 0 auto; text-align: center;">
                                  <center>
                                    <button type="submit" name="" id="" class="btn btn-success">ตกลง</button>
