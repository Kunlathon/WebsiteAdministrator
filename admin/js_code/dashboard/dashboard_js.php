...
<!---->
    <script src="<?php echo $RunLink->Call_Link_System();?>/js_code/tool_js/count_up_int/cdnjs/countUp.umd.min.js"></script>
    <script>
        ...
        let done = [];
            ...
            function s_counters() {
            const s_counters = document.querySelectorAll(".count-up");
