...
//news_image0
        ...
        if(($_FILES["news_image0"]["name"]!=null)){
            ...
            move_uploaded_file($news_image0_tmp, '../../../uploads/news/' . $news_image0_new_name);
            //up image end
...
//news_image1_1
        ...
        if(($_FILES["news_image1_1"]["name"]!=null)){
            ...
            move_uploaded_file($news_image1_1_tmp, '../../../uploads/news/' . $news_image1_1_new_name);
            //up image end
...
//news_image1_2
        ...
        if(($_FILES["news_image1_2"]["name"]!=null)){
            ...
            move_uploaded_file($news_image1_2_tmp, '../../../uploads/news/' . $news_image1_2_new_name);
            //up image end
...
//news_image2_1
        ...
        if(($_FILES["news_image2_1"]["name"]!=null)){
            ...
            move_uploaded_file($news_image2_1_tmp, '../../../uploads/news/' . $news_image2_1_new_name);
            //up image end
...
//news_image2_2
        ...
        if(($_FILES["news_image2_2"]["name"]!=null)){
            ...
            move_uploaded_file($news_image2_2_tmp, '../../../uploads/news/' . $news_image2_2_new_name);
            //up image end
...
//news_image3_1
        ...
        if(($_FILES["news_image3_1"]["name"]!=null)){
            ...
            move_uploaded_file($news_image3_1_tmp, '../../../uploads/news/' . $news_image3_1_new_name);
            //up image end
...
//news_image3_2
        ...
        if(($_FILES["news_image3_2"]["name"]!=null)){
            ...
            move_uploaded_file($news_image3_2_tmp, '../../../uploads/news/' . $news_image3_2_new_name);
            //up image end
...
//news_image4_1
        ...
        if(($_FILES["news_image4_1"]["name"]!=null)){
            ...
            move_uploaded_file($news_image4_1_tmp, '../../../uploads/news/' . $news_image4_1_new_name);
            //up image end
...
//news_image4_2
        ...
        if(($_FILES["news_image4_2"]["name"]!=null)){
            ...
            move_uploaded_file($news_image4_2_tmp, '../../../uploads/news/' . $news_image4_2_new_name);
            //up image end
...
//news_image5_1
        ...
        if(($_FILES["news_image5_1"]["name"]!=null)){
            ...
            move_uploaded_file($news_image5_1_tmp, '../../../uploads/news/' . $news_image5_1_new_name);
            //up image end
...
//news_image5_2
        ...
        if(($_FILES["news_image5_2"]["name"]!=null)){
            ...
            move_uploaded_file($news_image5_2_tmp, '../../../uploads/news/' . $news_image5_2_new_name);
            //up image end
...
//news_image5_2 end
        ...
        exit("<script>window.location='../../?modules=job_recruitment_news';</script>");
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    }elseif(($action=="edit")){
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//news_image0
        ...
        if(($_FILES["news_image0"]["name"]!=null)){
            ...
            $delete_image0="../../../uploads/news/".$copy_news_image0;
        ...
        if(($_FILES["news_image1_1"]["name"]!=null)){
            ...
            $delete_image1_1="../../../uploads/news/".$copy_news_image1_1;
        ...
        if(($_FILES["news_image1_2"]["name"]!=null)){
            ...
            $delete_image1_2="../../../uploads/news/".$copy_news_image1_2;
        ...
        if(($_FILES["news_image2_1"]["name"]!=null)){
            ...
            $delete_image2_1="../../../uploads/news/".$copy_news_image2_1;
        ...
        if(($_FILES["news_image2_2"]["name"]!=null)){
            ...
            $delete_image2_2="../../../uploads/news/".$copy_news_image2_2;
        ...
        if(($_FILES["news_image3_1"]["name"]!=null)){
            ...
            $delete_image3_1="../../../uploads/news/".$copy_news_image3_1;
        ...
        if(($_FILES["news_image3_2"]["name"]!=null)){
            ...
            $delete_image3_2="../../../uploads/news/".$copy_news_image3_2;
        ...
        if(($_FILES["news_image4_1"]["name"]!=null)){
            ...
            $delete_image4_1="../../../uploads/news/".$copy_news_image4_1;
        ...
        if(($_FILES["news_image4_2"]["name"]!=null)){
            ...
            $delete_image4_2="../../../uploads/news/".$copy_news_image4_2;
        ...
        if(($_FILES["news_image5_1"]["name"]!=null)){
            ...
            $delete_image5_1="../../../uploads/news/".$copy_news_image5_1;
        ...
        if(($_FILES["news_image5_2"]["name"]!=null)){
            ...
            $delete_image5_2="../../../uploads/news/".$copy_news_image5_2;
        ...
        foreach ($news_list as $key => $news_row) {
            ...
            while($count_inage<=10){
                if(($key_image[$count_inage]!=null)){
                    $delete_image="../../../uploads/news/".$key_image[$count_inage];  
                    unlink($delete_image);                                    
                }else{}
