...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
    ...
    <?php
            if((($picture_albumimg_name!=null))){
                if(file_exists("../../../uploads/gallery/".$gallery_folder."/".$picture_albumimg_name)){ ?>
...
<form name="form_picture<?php echo $gallery_id;?>" id="form_picture<?php echo $gallery_id;?>" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System();?>/?modules=picture_album" method="post" enctype="multipart/form-data">
    <input type="image" name="but_picture<?php echo $gallery_id;?>" id="but_picture<?php echo $gallery_id;?>" class="img-thumbnail" style="width:304px; height:236px;" src="../uploads/gallery/<?php echo $gallery_folder;?>/<?php echo $picture_albumimg_name;?>" border="0" title="<?php echo $picture_albumimg_name;?>">
    ...
    <?php       }else{ ?>
                        <div><img src="../uploads/gallery/no-image-icon-0.jpg" class="img-thumbnail" alt="no image" style="width:304px; height:236px;"></div>
    <?php       }
            }else{ ?>
                        <div><img src="../uploads/gallery/no-image-icon-0.jpg" class="img-thumbnail" alt="no image" style="width:304px; height:236px;"></div>
    <?php   } ?>
