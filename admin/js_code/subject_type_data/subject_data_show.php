                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div align="right">
                                                            <ul class="nav">
                                                                <li class="nav-item">
                                                                    <form name="update_sds<?php echo $row['subject_id']; ?>" id="update_sds<?php echo $row['subject_id']; ?>" accept-charset="utf-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=subject_data">
                                                                        ...
                                                                        <input type="hidden" name="id" id="id" value="<?php echo @$row['subject_id']; ?>"> <input type="hidden" name="manage" id="manage" value="form_update">
                                                                    </form>
                                                                ...
                                                                <form name="subject-type-data-delete" id="subject-type-data-delete" method="post" accept-charset="utf-8">
                                                                    <div class="row">
                                                                        <div class="col-<?php echo $grid; ?>-12">
                                                                            ...
                                                                            <div class="row" style="text-align: center;">
                                                                                <div class="col-<?php echo $grid; ?>-12">
                                                                                    <button type="button" id="delete_<?php echo $row['subject_id']; ?>" name="delete_<?php echo $row['subject_id']; ?>" class="btn btn-outline-success" value="<?php echo $row['subject_id']; ?>">ใช้</button>
                                                                                                    ...
                                                                                                    if (process_add.trim() === "no_error") {
                                                                                                        ...
                                                                                                        swalInitDeleteSubjectData.fire({
                                                                                                            ...
                                                                                                            if (result.dismiss === Swal.DismissReason.timer) {
                                                                                                                document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=subject_data&list=form_update&list=" + check_grade;
                                                                                                            } else {}
                                                                                                        });
