                                        ...
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitAddTeacherData1.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=teacher_data2&list="+td_id; 
                                                }else{}
                                            });
...
// ------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        ABA_Addteacher_data2.initComponentsAddTeacherData1();
    });
</script>
<!--Add End-->
...
// ------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        ABA_Upteacher_data2.initComponentsUpTeacherData1();
    });
</script>
<!--Update End-->
...
// ------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        ABA_Passteacher_data2.initComponentsPassTeacherData1();
    });
</script>
<!--Password End-->
