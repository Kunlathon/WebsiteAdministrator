                    ...
                    //var password_error="yes";
                        ...
                        if(action==""){
                            ...
                            if(name!="" && ename_error!="yes" && esurname_error!="yes" && username!="" && grade!="" && classroom!="" && status!=""){
                                $.post("<?php echo $RunLink->Call_Link_System();?>/js_code/student_resign/student_resign_process.php",{
                                    action:action,
                                    idcard:idcard,
                                    name:name,
                                    surname:surname,
                                        ...
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitEditStudentData.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=student_resign"; 
                                                }else{}
                                            });
