    ...
    <script>
        $(document).ready(function(){
            ...
            var category_key=$("#category_key").val();
                if(run_show==="show"){
                    $.post("<?php echo $RunLink->Call_Link_System();?>/js_code/document/document_show.php",{
                        run_show:run_show
                    },function(RunShow){
                        if(RunShow!=""){
                ...
                }else if(run_show==="show_data"){
                    $.post("<?php echo $RunLink->Call_Link_System();?>/js_code/document/document_show_data.php",{
                        run_show:run_show,
