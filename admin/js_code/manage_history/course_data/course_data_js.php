...
<script>
    var SA_AddCourseData = function() {
        var _componentSA_AddCourseData = function() {
            ...
            //--------------------------------------------------------------------------------------
            //--------------------------------------------------------------------------------------
            $('#Add_course_data').on('click', function() {
                            ...
                            if (course_detail_key != "" && subject_key != "" && level!="") {
                                ...
                                $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/course_data/course_data_process.php", {
                                    ...
                                    swalInitAddSubjectLevel.fire({
                                        ...
                                        if (result.dismiss === Swal.DismissReason.timer) {
                                            document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=course_data&manage="+manage+"&list="+list+"&id="+id+"&sid="+sid+"&cid="+cid;
                                        } else {}
                                    });
...
<script>
    var SA_UpCourseData = function() {
        var _componentSA_UpCourseData = function() {
            ...
            //--------------------------------------------------------------------------------------
            //--------------------------------------------------------------------------------------
            $('#Update_course_data').on('click', function() {
                            ...
                            if (course_key != "" && course_detail_key != "") {
                                $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/course_data/course_data_process.php", {
                                    ...
                                    swalInitAddCourseNo.fire({
                                        ...
                                        if (result.dismiss === Swal.DismissReason.timer) {
                                            document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=course_data&list=show&id=" + id_key;
                                        } else {}
                                    });
...
<script>
    $(document).ready(function() {
        $('#button_add').on('click', function() {
            document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=course_data&list=form_add&gid" + $list;
        })
    })
...
<script>
    $(document).ready(function() {
        $('#classSD').on('change', function() {
            ...
            var manage="show";
            if (classSD != "") {
                document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=course_data&manage="+manage+"&list="+classSD+"&id="+classSD;
            } else {}
        })
    })
</script>