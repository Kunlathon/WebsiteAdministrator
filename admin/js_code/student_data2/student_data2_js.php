                                    ...
                                    var test_process=process_add;
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitEditStudentData.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=student_data2&manage=form_edit&student_key="+id_key; 
                                                }else{}
                                            });
                                    ...
                                    var test_process=process_add;
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitPasswordStudentData.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=student_data2&manage=password&student_key="+id_key; 
                                                }else{}
                                            });
...
<script>
    $(document).ready(function() {
        $('#classroom_Reset').on('change', function() {
            ...
            document.location ="<?php echo $RunLink->Call_Link_System();?>/?modules=student_data2&classroom="+classroom_key;
        })
    })
</script>