                                    ...
                                    var test_process=process_add;
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitUpUserData.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=user_data2&manage=form_edit&admin_key="+id_key; 
                                                }else{}
                                            });
                                    ...
                                    var test_process=process_add;
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitPassUserData.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=user_data2&manage=password&teacher_key="+id_key; 
                                                }else{}
                                            });
