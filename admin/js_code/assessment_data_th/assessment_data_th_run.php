...
<div class="row">
    ...
    <?php
            $sql="SELECT * FROM tb_assessment_classroom 
                  WHERE classroom_t_id !='0' 
                  AND term_id = '{$check_term}' AND grade_id = '{$check_grade}' 
            ...
            $sql1="SELECT * FROM tb_assessment_classroom_detail 
                    a INNER JOIN tb_student b 
                    ON a.student_id = b.student_id 
                    WHERE a.a_classroom_id='{$row['a_classroom_id']}' 
                    AND a.a_classroom_detail_status='1' 
                    AND (b.student_no != '0' OR b.student_no != '') 
                    AND b.student_status='1' 
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
            ...
            <?php    }else{ ?>
                                            <div><span class="badge badge-danger">Not Checked</span</div>
            <?php    } ?>
                                        </td>
                                        <td><div>
                                            <ul class="nav">
                                                <li class="nav-item">
<form name="form_assessment_data_show" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=assessment_th_show">
