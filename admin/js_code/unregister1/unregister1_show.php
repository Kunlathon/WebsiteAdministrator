...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
    ...
    <?php
        $countA = 1;
        $sql = "SELECT * FROM `tb_register` WHERE user_status='3' ORDER BY user_studentid ASC";
        //$sql="SELECT user_studentid,user_student_no,user_idcard,user_name,user_name_buddhist,user_surname,user_name_en,user_name_buddhist_en,user_surname_en,user_type,user_date,user_email,user_degree FROM `tb_student` WHERE term_id = '$row[term_id]' AND user_degree='1' AND user_status='3' ORDER BY user_studentid ASC";
        ...
        foreach ($list as $key => $row){ 
            ...
            ?>
                ...
                <tr>
                    ...
                    <td align="center" style=" vertical-align: text-top;" class="align-top">
                        <div><span class="badge badge-danger"> ไม่ผ่านการอนุมัติ </span></div>
                    </td>
                    <td align="center" style=" vertical-align: text-top;" class="align-top">
                        <div></div>
                    </td>
