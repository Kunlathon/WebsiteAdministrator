...
<script>
    $(document).ready(function() {
        $("#classroom_key").on('change',function(){
            ...
            if(classroom_key!="" && term_key!="" && grade_key!=""){
                if(Number(grade_key)){
                    $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/report_achievement_update/report_achievement_update_show.php",{
