...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
                                            <table class="table table-bordered datatable-button-html5-columns-STD">
                                                <thead>
													...
													<tr>
                                                        ...
                                                        <div><a href="<?php echo $RunLink->Call_Link_System();?>/document/grade_report_all<?php echo $check_grade;?>_4.php?classroom=<?php echo $classroom;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>" title="พิมพ์ผลการเรียน" target="_blank" class="badge badge-danger p-1"><i class="icon-printer4"></i></a></div>
														
                                                        <!--<a href="document/grade_report_all2_4.php?classroom=<?php echo $classroom;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>" class="btn btn-sm grey-salsa" title="พิมพ์ผลการเรียน" target="_blank">
							...
							?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div><a  href="?modules=report_score_show<?php echo $check_grade;?>_G&id=<?php echo $row['student_id'];?>&classroom=<?php echo $classroom;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>" title="ผลการเรียน" class="badge badge-dark p-1" target="_blank"><i class="icon-file-text2"></i></a></div>

														<!--<a href="?modules=report_score_show2_G&id=<?php echo $row['student_id'];?>&classroom=<?php echo $classroom;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>" class="btn red btn-sm" title="ผลการเรียน" target="_blank">
														...
														<!--<a href="document/grade_report2_4.php?id=<?php echo $row['student_id'];?>&classroom=<?php echo $classroom;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>" class="btn btn-sm grey-salsa" title="ผลการเรียน" target="_blank">
																<i class="fa fa-print"></i> </a>-->
														...
														<td align="center"> 
                                                            ...
                                                            <div><a href="process/school_record<?php echo $check_grade;?>_process.php?id=<?php echo $row['student_id'];?>&classroom=<?php echo $classroom;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>&check_year=<?php echo $year1;?>" title="ปรับปรุงเกรด" class="badge badge-purple p-1">ปรับปรุงเกรด</a></div>
														<!--<a href="process/school_record2_process.php?id=<?php echo $row['student_id'];?>&classroom=<?php echo $classroom;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>&check_year=<?php echo $year1;?>" class="btn btn-sm yellow-gold">
																<i class="fa fa-cog"></i> ปรับปรุงเกรด</a> <br>-->

														<?php
															$sqlClass = "SELECT * FROM tb_classroom_teacher WHERE classroom_t_id = '$classroom'";
															$rowClass = row_array($sqlClass);

															$txt = $rowClass['classroom_name'];
															$txt_grade = substr($txt, 6 , 1);

															$gradename = "Grade $txt_grade";

															$sqlSr = "SELECT * FROM tb_school_record WHERE classroom_t_id='$classroom' AND term_id = '$check_term' AND grade_id = '$check_grade' AND school_record_year = '$year1' AND grade_name = '$gradename' AND student_id = '$row[student_id]' AND school_record_status='1'";
															$tcrSr = row_array($sqlSr);

															//echo $sqlSr;

															$adminupdate = $tcrSr['admin_update'];

															    if($adminupdate != null){ ?>
																
                                                                <div><?php echo date_th($adminupdate);?></div>
