...
<script>
     $(document).ready(function(){
        ...
        var check_grade=$("#check_grade").val();
            ...
            if(course_class_key!="" && class_key!="" && check_term!="" && check_grade!=""){
                $.post("<?php echo $RunLink->Call_Link_System();?>/js_code/course_manage/course_manage_show.php",{
                    course_class_key:course_class_key,
                    class_key:class_key,
                    check_term:check_term,
                    check_grade:check_grade
                },function(course_manage_show){
                    if(course_manage_show!=""){
                        $("#course_manage_show").html(course_manage_show)
                    }else{}
                })
            }else{}
