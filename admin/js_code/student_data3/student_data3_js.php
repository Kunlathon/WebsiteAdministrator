                            ...
                            if(password!=""){
                                if(password.length>=6){
                                    /*if(password.match(/^([0-9])+$/i)){
                                        ...
                                        document.getElementById("password-null").innerHTML=
                                        '<input type="text" name="password" id="password" class="form-control" value="'+password+'" placeholder="ข้อมูล Password เบื้องต้น เลขประจำตัวประชาชน" required="required">'+
                                        '<span class="invalid-feedback">ข้อมูล Password เบื้องต้น เลขประจำตัวประชาชน</span>'
                                        password_error="no";
                                }else{
                                    document.getElementById("password-null").innerHTML=
                                    '<input type="text" name="password" id="password" class="form-control is-invalid" value="'+password+'" placeholder="ข้อมูล Password เบื้องต้น เลขประจำตัวประชาชน" required="required">'+
                                    '<span class="invalid-feedback">Password อย่างน้อย 6 ตัว</span>'
                                    password_error="yes";
                                }
                            }else{
                                document.getElementById("password-null").innerHTML=
                                '<input type="text" name="password" id="password" class="form-control is-invalid" value="" placeholder="ข้อมูล Password เบื้องต้น เลขประจำตัวประชาชน" required="required">'+
                                    ...
                                    var test_process=process_add;
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitEditStudentData.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=student_data3&manage=form_edit&student_key="+id_key; 
                                                }else{}
                                            });
                                    ...
                                    var test_process=process_add;
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitPasswordStudentData.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=student_data3&manage=password&student_key="+id_key; 
                                                }else{}
                                            });
...
<script>
    $(document).ready(function() {
        $('#classroom_Reset').on('change', function() {
            ...
            document.location ="<?php echo $RunLink->Call_Link_System();?>/?modules=student_data3&classroom="+classroom_key;
        })
    })
</script>