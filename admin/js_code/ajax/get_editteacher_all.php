...
$row = row_array($sql);
?>			
											<form action="process/teacher_all_process.php" method="post" enctype="multipart/form-data">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
												<h4 class="modal-title">ฟอร์มแก้ไขข้อมูลครู</h4>
											</div>
											<div class="modal-body">
												<div class="row">
													...
													<div class="form-group">
														...
														<div class="form-group">
															<label class="col-md-4 control-label">ประเภทครู</label>

															<div class="col-md-8">
																		<select name="ttype" class="form-control" required>
																			<option value="" disabled selected>เลือกประเภทครู</option>
