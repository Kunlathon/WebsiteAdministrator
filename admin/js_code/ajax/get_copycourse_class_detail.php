...
?>			
											<form action="process/copycourse_class_detail_process.php" method="post">
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																		<select name="classroom" class="form-control" required>
																			...
																			<?php
																			$sql = "SELECT * FROM tb_classroom_teacher WHERE grade_id = '$check_grade' ORDER BY classroom_name ASC";
																			$rclass = result_array($sql);
																		   ?>
																		   <?php foreach ($rclass as $_rclass) { ?>
																						<option <?php echo $classroom == $_rclass['classroom_t_id'] ? "selected":""; ?>
																							value="<?php echo $_rclass['classroom_t_id'] ?>"><?php echo $_rclass['classroom_name'] ?></option>
																		  <?php } ?>
																		</select>
