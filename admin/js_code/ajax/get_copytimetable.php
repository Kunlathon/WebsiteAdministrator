...
?>			
											<form action="process/copytimetable_process.php" method="post">
												...
												<div class="row">
													...
													<input type="hidden" name="cy" value="<?php echo $cy;?>">	
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																<input class="form-control form-control-inline input-medium" size="16" type="number" name="num" value="" />
																<span class="help-block"> กรอกข้อมูลจำนวน</span>
															</div>
														</div>
														<div>&nbsp;</div>
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																<textarea class="wysihtml5 form-control" rows="3" name="memo"><?php echo $row['memo'] ?></textarea>
															</div>
														</div>
														<div>&nbsp;</div>
