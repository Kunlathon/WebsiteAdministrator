...
if($row['score_name'] != ""){
	$name_score = "ตัวชี้วัด $row[score_name]";
}
...
?>			
											<form action="process/scores_add_process.php" method="post">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
												<h4 class="modal-title">ฟอร์มแก้ไขข้อมูลคะแนน วิชา<?php echo $subject_name; ?>&nbsp;<?php echo $name_score; ?></h4>
											</div>
