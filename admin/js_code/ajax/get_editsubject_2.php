...
$sql = "SELECT * FROM tb_course_class_detail WHERE course_class_detail_id = '$cdid'";
$row = row_array($sql);
?>			
											<form action="process/subject_2_process.php" method="post">
											...
											<div class="modal-body">
												<div class="row">
													...
													<input type="hidden" name="subject" id="subject" value="<?php echo $id; ?>">
