...
$exam_no2 = 2;
?>			
											<form action="process/copy_subject_scores1_process.php" method="post">
											...
											<div class="modal-body">
												<div class="row">
													...
													<input type="hidden" name="exam_no2" id="exam_no2" value="<?php echo $exam_no2; ?>">	
													...
													<input type="hidden" name="typec" id="typec" value="<?php echo $typec; ?>">	
														...
														<div class="form-group">
															<label class="col-md-6 control-label">คะแนนวิชา(สำเนา) ครั้งที่ <?php echo $exam_no2; ?></label>
