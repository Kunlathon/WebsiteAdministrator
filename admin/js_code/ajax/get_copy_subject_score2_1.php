...
if (isset($_REQUEST['check_grade'])) {
	...
	$cclid=isset($_GET['cclid']) ? $_GET['cclid'] : '';
...
$sqlS = "SELECT * FROM tb_subject a INNER JOIN tb_subject_type b ON a.subt_id=b.subt_id WHERE a.subject_id='{$sid}' AND a.grade_id = '$check_grade'";
$rowS = row_array($sqlS);

?>			
											<form action="process/copy_subject_score2_1_process.php" method="post">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
												<h4 class="modal-title">สำเนาคะแนนสอบ <?php echo $row['course_class_name']; ?> <?php echo $grade; ?></h4>
											</div>
												...
												<div class="row">
													...
													<input type="hidden" name="type" id="type" value="<?php echo $type; ?>">	
														...
														<div class="form-group">
															<label class="col-md-4 control-label">คะแนนสอบวิชา(ต้นฉบับ)</label>

															<div class="col-md-8">
															<?php echo $rowS['subject_code'];?> - <?php echo $rowS['subject_name'] ?>  ครั้งที่ 2
															</div>
														</div>
														<div>&nbsp;</div>

														<div class="form-group">
															<label class="col-md-4 control-label">คะแนนสอบวิชา(สำเนา)</label>

															<div class="col-md-8">
															<?php echo $rowS['subject_code'];?> - <?php echo $rowS['subject_name'] ?>  ครั้งที่ 1
															</div>
														</div>
														<div>&nbsp;</div>	
