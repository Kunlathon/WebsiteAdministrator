...
?>	
											<form action="process/doublecheck_add_process.php" name="frmMain" method="post">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
												<h4 class="modal-title">จัดการนักเรียน(ดับเบิลคะแนน) ห้องเรียน <?php echo $rowC['classroom_name']; ?></h4>
											</div>
												...
												<div class="row">
													...
													<!--<table class="table table-striped table-hover" id="sample_2">-->
														...
														?>
															...
															$sqlCo = "SELECT * FROM tb_payment a INNER JOIN tb_payment_student b ON a.payment_id = b.payment_id WHERE a.payment_id = '$pid' AND a.grade_id = '{$check_grade}' AND a.term_id = '{$check_term}' AND b.student_id = '$row[student_id]'";
