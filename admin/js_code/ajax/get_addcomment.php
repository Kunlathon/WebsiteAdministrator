...
?>			
											<form action="process/comment_add_process.php" method="post">
													...
													<table class="table table-striped table-hover">
														...
														?>
															...
															<tr>
																...
																<div class="form-group">
																	<label class="col-md-4 control-label"><?php echo $assessment_name;?></label>														
																	<div class="col-md-8">
																			<textarea class="form-control" rows="5" name="txtdetail"><?php echo $memo;?></textarea>
