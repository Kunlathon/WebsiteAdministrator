...
$rowc = row_array($sqlc);
?>			
											<form action="document/grade_report_previous3_1.php" method="post" target="_blank">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
												<h4 class="modal-title">ฟอร์มตั้งค่าการพิมพ์ผลคะแนนครํ้งที่ 1 (ย้อนหลัง)</h4>
											</div>
												...
												<div class="row">
													...
													<!--<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																<input class="form-control form-control-inline" size="16" type="number" name="stu_no" value="<?php echo $rowc['student_no'];?>" />
