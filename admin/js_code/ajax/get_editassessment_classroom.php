...
$row = row_array($sql);
?>			
											<form action="process/assessment_classroom_process.php" method="post">
											...
											<div class="modal-body">
												<div class="row">
													...
													<!--<div class="form-group">
														...
														<div class="form-group">
															<label class="col-md-4 control-label">ครูผู้สอน(ESL)</label>

															<div class="col-md-8">
																<div class="input-group select2-bootstrap-append">
																			<select id="single-append-add1-2" name="teacher_esl" class="form-control select2-allow-clear">
																				<option value="" disabled selected>เลือกครูผู้สอน(ESL)</option>
																				<?php
																				$sql = "SELECT * FROM  tb_teacher WHERE teacher_status='1' ORDER BY teacher_name ASC";
																				$tt = result_array($sql);
																				?>
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																<div class="input-group select2-bootstrap-append">
																			<select id="single-append-add1-2" name="teacher3" class="form-control select2-allow-clear">
