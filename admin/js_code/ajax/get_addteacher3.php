...
$row = row_array($sql);
?>			
											<form action="process/addteacher3_process.php" method="post" enctype="multipart/form-data">
													...
													<div class="form-group">
															...
															<div class="col-md-8">
																<div class="input-group select2-bootstrap-append">
																			<select id="single-append-add3-1" name="teacher1" class="form-control select2-allow-clear" required>
																			...
																			<button class="btn btn-default" type="button" data-select2-open="single-append-add3-1">
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																<div class="input-group select2-bootstrap-append">
																			<select id="single-append-add3-2" name="teacher2" class="form-control select2-allow-clear">
																				<option value="" disabled selected>เลือกครูผู้สอน</option>
																				<?php
																				$sql = "SELECT * FROM  tb_teacher ORDER BY teacher_name ASC";
																				$tt = result_array($sql);
