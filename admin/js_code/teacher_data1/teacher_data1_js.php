...
<!--Add-->
<script>
	var ABA_Addteacher_data1 = function () {
            var _componentABA_Addteacher_data1 = function() {
                if (typeof swal == 'undefined') {
                    console.warn('Warning - sweet_alert.min.js is not loaded.');
                    return;
                }
// Defaults
                var swalInitAddTeacherData1 = swal.mixin({
...
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
		$('#Add_teacher_data1').on('click', function() {
            swalInitAddTeacherData1.fire({
                                        ...
                                        if(test_process.trim()==="no_error"){
                                            ...
                                            swalInitAddTeacherData1.fire({
                                                ...
                                                if (result.dismiss === Swal.DismissReason.timer) {
                                                    document.location="<?php echo $RunLink->Call_Link_System();?>/?modules=teacher_data1&list="+td_id; 
                                                }else{}
                                            });
...
//--------------------------------------------------------------------------------------
        return {
            initComponentsAddTeacherData1: function() {
                _componentABA_Addteacher_data1();
            }
        }
    }();
// Initialize module
// ------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        ABA_Addteacher_data1.initComponentsAddTeacherData1();
    });
</script>
<!--Add End-->
...
<!--Update-->
<script>
	var ABA_Upteacher_data1 = function () {
            var _componentABA_Upteacher_data1 = function() {
                if (typeof swal == 'undefined') {
                    console.warn('Warning - sweet_alert.min.js is not loaded.');
                    return;
                }
...
// ------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        ABA_Upteacher_data1.initComponentsUpTeacherData1();
    });
</script>
<!--Update End-->
...
<!--Password-->
<script>
	var ABA_Passteacher_data1 = function () {
            var _componentABA_Passteacher_data1 = function() {
                if (typeof swal == 'undefined') {
                    console.warn('Warning - sweet_alert.min.js is not loaded.');
                    return;
                }
...
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
		$('#password_teacher_data1').on('click', function() {
...
//--------------------------------------------------------------------------------------
        return {
            initComponentsPassTeacherData1: function() {
                _componentABA_Passteacher_data1();
            }
        }
    }();
// Initialize module
// ------------------------------
    document.addEventListener('DOMContentLoaded', function() {
        ABA_Passteacher_data1.initComponentsPassTeacherData1();
    });
</script>
<!--Password End-->
