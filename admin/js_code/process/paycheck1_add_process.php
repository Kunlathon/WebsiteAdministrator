...
if($pay==1) {
    ...
    echo "<meta charset='utf-8'/><script>alert('เพิ่มข้อมูลสำเร็จ!!');location.href='../?modules=payment_show1&id=$rid&check_term=$check_term&check_grade=$check_grade';</script>"
