...
$row = row_array($sql);
	...
	//echo " $row[T1] - <br>$row[T2] - ";
		...
		//$sql = "SELECT * FROM tb_score WHERE course_class_id='{$cid}' AND classroom_t_id ='{$rid}' AND teacher_id='{$tid}' AND score_no = '{$exam_no}' AND grade_id='{$check_grade}' AND term_id='{$check_term}'";
