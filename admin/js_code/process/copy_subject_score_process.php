...
foreach ($list as $key => $row) {
	...
	//echo " $row[T1] - <br>$row[T2] - ";
		...
		echo "<meta charset='utf-8'/><script>alert('สำเนาข้อมูลสำเร็จ!!');location.href='../?modules=check_subject_show&id=$cid&rid=$rid&check_term=$check_term&check_grade=$check_grade';</script>";
