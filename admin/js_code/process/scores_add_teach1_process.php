...
for($i=0;$i<$count;$i++){
	...
	//echo "<meta charset='utf-8'/><script>location.href='../?modules=check_subject_teach_detail&id=$sid&idd=$idd&tid=$tid&cdid=$cdid&cid=$cid&rid=$clid&exam_no=$exam_no&typec=$typec&check_term=$check_term&check_grade=$check_grade';</script>";
