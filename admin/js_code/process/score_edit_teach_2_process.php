...
if($rowSco['score_max'] >= $unit){
	...
	//echo "check_subject_teach_detail2&id=$rowSco[subject_id]&idd=$rowSco[teacher_type]&tid=$rowSco[teacher_id]&cid=$rowSco[course_class_id]&clid=$rowSco[classroom_id]&check_grade=$rowSco[grade_id]&check_term=$rowSco[term_id]";
