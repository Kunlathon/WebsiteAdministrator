...
if (($teacher1 != "") && ($teacher2 != "") && ($teacher3 != "")){
		...
		echo "<meta charset='utf-8'/><script>alert('เพิ่มข้อมูลสำเร็จ!!');location.href='../?modules=course_subject_show&id=$id&cdid=$cdid&cid=$cid&rid=$rid&check_grade=$check_grade&check_term=$check_term';</script>";
