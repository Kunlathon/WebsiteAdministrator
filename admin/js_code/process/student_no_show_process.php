...
if($status==2){
    ...
    echo "<meta charset='utf-8'/><script>alert('แก้ไขข้อมูลสำเร็จ!!');location.href='../?modules=classroom_course_show&id=$cid&check_term=$check_term&check_grade=$check_grade';</script>";
