...
function fnc_count($cid,$term,$grade,$stuid)   
{
    $s = "SELECT * FROM tb_course_student WHERE course_class_id = '$cid' AND term_id='$term' AND grade_id='$grade' AND student_id='$stuid' AND course_s_status='1'";
    $q = row_array($s);
...
$check = fnc_count($cid,$term,$grade,$stuid);
