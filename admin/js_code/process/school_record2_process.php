...
?>
	...
	<?php
	echo "<meta charset='utf-8'/><script>alert('แก้ไขข้อมูลสำเร็จ!!');location.href='../?modules=report_achievement_update_2&classroom=$classroom&check_term=$check_term';</script>";
	?>