...
if (empty($id)) {
	...
	if ($check) {
		...
		echo "<meta charset='utf-8'/><script>alert('เพิ่มข้อมูลสำเร็จ!!');location.href='../?modules=teacher_data1&id=$name_id';</script>";
    ...
    echo "<meta charset='utf-8'/><script>alert('แก้ไขข้อมูลสำเร็จ!!');location.href='../?modules=teacher_data1&id=$name_id';</script>";
