...
$update = date('Y-m-d H:i:s');
		...
		$data1 = array(
			...
			"teacher_check" => $tcr['teacher_check'] ,
			"check_status" => $tcr['check_status'] ,
			"check_date" => $tcr['check_date'] ,
			"admin_id" => $aid,		
			"admin_update" => $update,
		...
		foreach ($list as $key => $row) { 
			...
			foreach ($listCcd as $key => $rowCcd) { 
				...
				$data4 = array(
					...
					"sort" => $rowCcd['sort'] ,
					"teacher_check" => $rowCcd['teacher_check'] ,
					"check_status" => $rowCcd['check_status'] ,
					"check_date" => $rowCcd['check_date'] ,
					"teacher_check2" => $rowCcd['teacher_check2'] ,
					"check_status2" => $rowCcd['check_status2'] ,
					"check_date2" => $rowCcd['check_date2'] ,
					"admin_check" => $rowCcd['admin_check'] ,
					"admin_check_status" => $rowCcd['admin_check_status'] ,
					"admin_check_date" => $rowCcd['admin_check_date'] ,
					"admin_check2" => $rowCcd['admin_check2'] ,
					"admin_check_status2" => $rowCcd['admin_check_status2'] ,
					"admin_check_date2" => $rowCcd['admin_check_date2'] ,
					"admin_id" => $aid,		
					"admin_update" => $update,
