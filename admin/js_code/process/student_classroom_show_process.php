...
if (empty($id)) {
	...
	if ($check) {
		...
		echo "<meta charset='utf-8'/><script>alert('เพิ่มข้อมูลสำเร็จ!!');location.href='../?modules=classroom_show&id=$classroomT&check_term=$check_term&check_grade=$grade';</script>";
...
if($status==2){
    ...
    echo "<meta charset='utf-8'/><script>alert('แก้ไขข้อมูลสำเร็จ!!');location.href='../?modules=classroom_show&id=$classroomT&check_term=$check_term&check_grade=$grade';</script>";
