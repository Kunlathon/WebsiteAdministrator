            ...
            minimumResultsForSearch: Infinity
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                ...
                                                $('.file-update-custom-A').fileinput({
...
<script src="<?php echo $RunLink->Call_Link_System();?>/template/global_assets/js/plugins/media/glightbox.min.js"></script>
