    ...
    if(($action=="add")){
        ...
        if ($check) {
            ...
            if(($_POST["document_topic"]!=null and $_FILES["document_file"]["name"]!=null)){
                ...
                move_uploaded_file($document_file_tmp, '../../../dist/document/' . $document_file_new_name);
                //up image end
            ...
            if(($_POST["document_topic_en"]!=null and $_FILES["document_file_en"]["name"]!=null)){
                ...
                move_uploaded_file($document_file_en_tmp, '../../../dist/document/' . $document_file_en_new_name);
                //up image end
            ...
            if(($_POST["document_topic_cn"]!=null and $_FILES["document_file_cn"]["name"]!=null)){
                ...
                move_uploaded_file($document_file_cn_tmp, '../../../dist/document/' . $document_file_cn_new_name);
                //up image end
        ...
        if(($_POST["document_topic"]!=null and $_FILES["document_file"]["name"]!=null)){
            ...
            $delete_copy_document_file="../../../dist/document/".$copy_document_file;
        ...
        if(($_POST["document_topic_en"]!=null and $_FILES["document_file_en"]["name"]!=null)){
            ...
            $delete_copy_document_file_en="../../../dist/document/".$copy_document_file_en;
        ...
        if(($_POST["document_topic_cn"]!=null and $_FILES["document_file_cn"]["name"]!=null)){
            ...
            $delete_copy_document_file_cn="../../../dist/document/".$copy_document_file_cn;
        ...
        $copy_file_nameCn=filter_input(INPUT_POST, 'copy_file_nameCn');
            ...
            if((isset($copy_file_nameTh))){
                $delete_copy_document_file_Th="../../../dist/document/".$copy_file_nameTh;
                unlink($delete_copy_document_file_Th);
            }else{}

            if((isset($copy_file_nameEn))){
                $delete_copy_document_file_En="../../../dist/document/".$copy_file_nameEn;
                unlink($delete_copy_document_file_En);
            }else{}

            if((isset($copy_file_nameCn))){
                $delete_copy_document_file_cn="../../../dist/document/".$copy_file_nameCn;
                unlink($delete_copy_document_file_cn);
            }else{}
