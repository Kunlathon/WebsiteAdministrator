...
<script>
    $(document).ready(function() {
        $('#check_term').on('change', function() {
            ...
            if ((ct_key != "")) {
                $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/report_score/report_score_classroom2.php", {
                    ct_key: ct_key,
                    cg_key: cg_key
                }, function(run_ct) {
                    if (run_ct != "") {
    ...
    $(document).ready(function() {
        $('#classroom').on('change', function() {
            ...
            if ((check_term != "" && check_classroom != "" && check_grade != "" && class_name != "")) {
                $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/report_score/report_score_table2.php", {
