                                    ...
                                    <tbody>
                                        ...
                                        if (($classroom != null)) {
                                            if ((check_session("admin_status_lcm") == '1') || (check_session("admin_status_lcm") == '4') || (check_session("admin_status_lcm") == '5')) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <div>
                                                            <form name="print1" id="print1" action="<?php echo $RunLink->Call_Link_System(); ?>/document/grade_report_all2_1.php" method="get" target="_blank">
                                                    ...
                                                    <td align="center">
                                                        <div>
                                                            <form name="print2" id="print2" action="<?php echo $RunLink->Call_Link_System(); ?>/document/grade_report_all2_2.php" method="get" target="_blank">
                                                    ...
                                                    <td align="center">
                                                        <div>
                                                            <form name="print3" id="print3" action="<?php echo $RunLink->Call_Link_System(); ?>/document/grade_report_all2_3.php" method="get" target="_blank">
                                                    ...
                                                    <td align="center">
                                                        <div>
                                                            <form name="print4" id="print4" action="<?php echo $RunLink->Call_Link_System(); ?>/document/grade_report_all2_4.php" method="get" target="_blank">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <div>
                                                        <form name="show1<?php echo @$row['student_id']; ?>" id="show1<?php echo @$row['student_id']; ?>" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=report_score_show2" method="get">
                                                            ...
                                                            <input type="hidden" name="modules" id="modules" value="report_score_show2">
                                                ...
                                                <td align="center">
                                                    <div>
                                                        <form name="show2<?php echo @$row['student_id']; ?>" id="show2<?php echo @$row['student_id']; ?>" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=report_score_show2_2" method="get">
                                                            ...
                                                            <input type="hidden" name="modules" id="modules" value="report_score_show2_2">
                                                            <input type="hidden" name="id" id="id" value="<?php echo $row['student_id']; ?>">
                                                            <input type="hidden" name="classroom" id="classroom" value="<?php echo $classroom; ?>">
                                                            <input type="hidden" name="check_grade" id="check_grade" value="<?php echo $check_grade; ?>">
                                                            <input type="hidden" name="check_term" id="check_term" value="<?php echo $check_term; ?>">
                                                ...
                                                <td align="center">
                                                    <div>
                                                        <form name="show3<?php echo @$row['student_id']; ?>" id="show3<?php echo @$row['student_id']; ?>" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=report_score_show2_F" method="get">
                                                            ...
                                                            <input type="hidden" name="modules" id="modules" value="report_score_show2_F">
                                                            <input type="hidden" name="id" id="id" value="<?php echo $row['student_id']; ?>">
                                                            <input type="hidden" name="classroom" id="classroom" value="<?php echo $classroom; ?>">
                                                            <input type="hidden" name="check_grade" id="check_grade" value="<?php echo $check_grade; ?>">
                                                            <input type="hidden" name="check_term" id="check_term" value="<?php echo $check_term; ?>">
                                                ...
                                                <td align="center">
                                                    <div>
                                                        <form name="show4<?php echo @$row['student_id']; ?>" id="show4<?php echo @$row['student_id']; ?>" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=report_score_show2_G" method="get">
                                                            ...
                                                            <input type="hidden" name="modules" id="modules" value="report_score_show2_G">
                                                            <input type="hidden" name="id" id="id" value="<?php echo $row['student_id']; ?>">
                                                            <input type="hidden" name="classroom" id="classroom" value="<?php echo $classroom; ?>">
                                                            <input type="hidden" name="check_grade" id="check_grade" value="<?php echo $check_grade; ?>">
                                                            <input type="hidden" name="check_term" id="check_term" value="<?php echo $check_term; ?>">
