                    ...
                    <td align="center" style="width: 5%; vertical-align: text-top;" class="align-top">
                        <div align="center">
                            <ul class="nav justify-content-center">
                                <li class="nav-item">
<form name="news_update<?php echo $news_row["news_id"];?>" accept-charset="utf-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=public_news">
                ...
                swalInitDeteleImageData.fire({
                    ...
                    if(result.value){
                        ...
                        if(action_error=="no_error" && news_id_error=="no_error"){
                            $.post("<?php echo $RunLink->Call_Link_System();?>/js_code/public_news/public_news_process.php",{
                                action:action,
                                news_id:news_id
                                    ...
                                    let timerInterval;
                                        swalInitDeteleImageData.fire({
                                            ...
                                            if (result.dismiss === Swal.DismissReason.timer) {
                                                document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=public_news";
                                            } else {}
                                        });
