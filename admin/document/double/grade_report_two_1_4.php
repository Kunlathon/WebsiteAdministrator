                                        ...
                                        <div class="table-scrollable">
											...
											//if($subject_code_g) { // ตรวจสอบรายวิชา
												...
												if($teacherid1_3 != "" && ($teacherid2_3 == "" || $teacherid2_3 == 0)) {
													...
													$sqlSco1_1_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id' AND b.score!='0'";
													...
													foreach ($list1_1_3 as $key => $rowSco1_1_3) { 
														...
														$sqlSco1_2_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id' AND b.score!='0'";
