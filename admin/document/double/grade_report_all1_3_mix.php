											...
											//if($subject_code_g) { // ตรวจสอบรายวิชา
												...
												if($teacherid1 != "" && ($teacherid2 == "" || $teacherid2 == 0)) {
													...
													foreach ($list1 as $key => $rowSco1) { 
														...
														$sqlSco2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses1}' AND b.course_class_detail_id='{$coursedetail1}' AND b.course_class_level_id = '$course_class_lid1' AND c.course_s_id='{$courses_id1}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id' AND b.score!='0'";
													...
													//echo "$max_s-$sum_s-$rate1-$score1_1<br>";
														...
														if($score1==0 && $score2==0) {			
															...
															foreach ($rowCourse1 as $_rowCourse1) { 
																...
																$sqlSco1 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$cc__id1}' AND b.course_class_detail_id='{$cd__id1}' AND b.course_class_level_id = '$cl__id1' AND c.course_s_id='{$courses_s_id1}' AND d.subject_id ='{$sj__id1}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
																...
																//echo "$max_s1-$sum_s1-$rate1-$score1_1<br>";
																	...
																	$sqlSco2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$cc__id1}' AND b.course_class_detail_id='{$cd__id1}' AND b.course_class_level_id = '$cl__id1' AND c.course_s_id='{$courses_s_id1}' AND d.subject_id ='{$sj__id1}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
