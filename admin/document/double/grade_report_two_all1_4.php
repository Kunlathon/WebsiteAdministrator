					...
					<table  cellSpacing='0' cellPadding='0' border='0' width='794px;' bgcolor='#FFFFFF' class='th_niramit_as'>
						<tr> 
							...
							<td width='694px;' align="center" valign="top"><p class='data'>
								...
								<strong>โรงเรียนยุวฑูตศึกษาราชพฤกษ์ / Ambassador Bilingual Academy<br>
								การประเมินผลสัมฤทธิ์ ปีการศึกษา <?php echo $year1;?> / Assessment Academic Year <?php echo $year2;?></strong><br>
								<div style="display:block;width:500px;height:15px">
								<?php 
									$txt = $row['classroom_name'];
									$txt_grade = substr($txt, 6 , 1);
								?>
								<strong>ชั้นประถมศึกษาปีที่ <?php echo class_status($txt_grade);?> / Grade <?php echo $txt_grade;?></strong><br>
                                            ...
                                            <table width="780" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333">
                                                <thead>
                                                    <tr bgcolor="#dcdcdc">
														...
														<th width="64">รหัสวิชา <br>Subject Code</th>  
                                                        <th width="385"> รายวิชา/Subject </th>
														<th width="118"> ประเภท <br>Category</th>
														<th width="66"> หน่วยกิต <br>Credit</th>
														<th width="66"> คะแนนรวม/Total <br>100% </th>
                                                        <th width="66"> ผลการเรียน <br>Grade </th>
											...
											//if($subject_code_g) { // ตรวจสอบรายวิชา
												...
												?>
                                                    <tr>
														...
														if($rowSubt['subt_id']==2 || $rowSubt['subt_id']==3){
														?>
														...
														?>
														<td align="center"><font size="2"><?php echo $rowSubt['subt_name'];?>/<?php echo $rowSubt['subt_name_eng'];?></font></td>
														<?php
														} 
														?>
													...
													?>
														...
														<td align="center"><?php echo number_format($subweight_show,1);?></td>

														<?php 
														if($subtid=='1'){
																																
															if ($total_subweight1 != 0) {
												...
												if($teacherid1_2 != "" && ($teacherid2_2 == "" || $teacherid2_2 == 0)) {
													...
													$sqlSco1_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses1}' AND b.course_class_detail_id='{$coursedetail1}' AND b.course_class_level_id = '$course_class_lid1_2' AND c.course_s_id='{$courses_id1}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='1' AND b.student_id='$student_id' AND b.score!='0'";
													...
													foreach ($list1_2 as $key => $rowSco1_2) { 
														...
														$sqlSco2_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses1}' AND b.course_class_detail_id='{$coursedetail1}' AND b.course_class_level_id = '$course_class_lid1_2' AND c.course_s_id='{$courses_id1}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='1' AND b.student_id='$student_id' AND b.score!='0'";
													...
													//echo "$max_s2-$sum_s2-$rate1_2-$score1_1_2<br>";
														...
														if($score1_2==0 && $score2_2==0) {			
															...
															foreach ($rowCourse1_2 as $_rowCourse1_2) { 
																...
																$sqlSco1_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$cc__id1_2}' AND b.course_class_detail_id='{$cd__id1_2}' AND b.course_class_level_id = '$cl__id1_2' AND c.course_s_id='{$courses_s_id1_2}' AND d.subject_id ='{$sj__id1_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='1' AND b.student_id='$student_id'";
																...
																//echo "$max_s2-$sum_s2-$rate1-$score1_1_2<br>";
																	...
																	$sqlSco2_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$cc__id1_2}' AND b.course_class_detail_id='{$cd__id1_2}' AND b.course_class_level_id = '$cl__id1_2' AND c.course_s_id='{$courses_s_id1_2}' AND d.subject_id ='{$sj__id1_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='1' AND b.student_id='$student_id'";
													...
													$sqlSco1_1_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses1}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail1}' AND b.course_class_level_id = '$course_class_lid1_2' AND c.course_s_id='{$courses_id1}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='1' AND b.student_id='$student_id'";
													...
													foreach ($list1_1_2 as $key => $rowSco1_1_2) { 
														...
														$sqlSco1_2_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses1}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail1}' AND b.course_class_level_id = '$course_class_lid1_2' AND c.course_s_id='{$courses_id1}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='1' AND b.student_id='$student_id'";
													...
													$sqlSco2_1_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses1}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail1}' AND b.course_class_level_id = '$course_class_lid1_2' AND c.course_s_id='{$courses_id1}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid2_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='1' AND a.score_no ='1' AND a.score_status='1' AND b.student_id='$student_id'";
													...
													foreach ($list2_1_2 as $key => $rowSco2_1_2) { 
														...
														$sqlSco2_2_2 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses1}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail1}' AND b.course_class_level_id = '$course_class_lid1_2' AND c.course_s_id='{$courses_id1}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid2_2}' AND a.grade_id = '{$check_grade1}' AND a.term_id = '{$check_term1}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='1' AND b.student_id='$student_id'";
												...
												if($teacherid1_3 != "" && ($teacherid2_3 == "" || $teacherid2_3 == 0)) {
													...
													$sqlSco1_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id' AND b.score!='0'";
													...
													foreach ($list1_3 as $key => $rowSco1_3) { 
														...
														$sqlSco2_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id' AND b.score!='0'";
														...
														if($score1_3==0 && $score2_3==0) {			
															...
															foreach ($rowCourse1_3 as $_rowCourse1_3) { 
																...
																//echo "$max_s3-$sum_s3-$rate1_3-$score1_1_3<br>";
																	...
																	$sqlSco2_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$cc__id1_3}' AND b.course_class_detail_id='{$cd__id1_3}' AND b.course_class_level_id = '$cl__id1_3' AND c.course_s_id='{$courses_s_id2}' AND d.subject_id ='{$sj__id1_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
													...
													$sqlSco1_1_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
													...
													foreach ($list1_1_3 as $key => $rowSco1_1_3) { 
														...
														$sqlSco1_2_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
													...
													$sqlSco2_1_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid2_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='1' AND a.score_no ='2' AND a.score_status='1' AND b.student_id='$student_id'";
													...
													foreach ($list2_1_3 as $key => $rowSco2_1_3) { 
														...
														$sqlSco2_2_3 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$courses2}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail2}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id2}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid2_3}' AND a.grade_id = '{$check_grade2}' AND a.term_id = '{$check_term2}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
												...
												?>
														...
														echo "<font size=2>$course_cln_show</font>";
                                                ...
                                                <tbody>
													 <tr valign="top">
														...
														<tr>
															...
															<td align="center" width="110"><font size="2">ผ่าน/PASS</font></td>
														...
														<tr>
															...
															<td align="center" width="110"><?php echo number_format($total_subweight_show1,1);?></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td align="center" width="110"><?php echo number_format($total_subweight_show3,1);?></td>
														</tr>
