						...
						<td width='794px' colspan='2' align="center">
							<table cellSpacing='0' cellPadding='0' border='0' width='794px' bgcolor='#FFFFFF' class='th_niramit_as'>
								<tr>
									...
									<td width='694px'' align="center" valign="top">
										<p class='data'>
						...
						<td width='780' colspan='2'>
							...
							<table width="780" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="220" align="left">&nbsp;<?php echo $row['student_name']; ?>&nbsp;<?php echo $row['student_surname']; ?></td>
								...
								<tr>
									...
									<td width="220" align="left">&nbsp;<?php echo $row['student_name_eng']; ?>&nbsp;<?php echo $row['student_surname_eng']; ?></td>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td align="left">
												<font size="2">&nbsp;<?php echo $row['subject_name']; ?> / <?php echo $row['subject_name_eng']; ?></font>&nbsp;
