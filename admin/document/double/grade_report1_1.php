                                            ...
                                            <table width="780" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333">
                                                <thead>
													...
													<tr bgcolor="#dcdcdc">
														...
														<th width="65">รหัสวิชา <br>Subject Code</th>  
														<th width="370"> รายวิชา/Subject </th>
														<th width="79"> คะแนนเก็บตามตัวชี้วัด <br>Standards Score </th>
														<th width="79"> คะแนนสอบ <br>Test Score </th>
														<th width="79"> คะแนนรวม/Total <br>100% </th>
                                                        <th width="79"> สัดส่วนคะแนน <br> Ratio </th>
                                                    </tr>
												...
												if($teacherid1 != "" && ($teacherid2 == "" || $teacherid2 == 0)) {
													...
													//echo "$rate1 - $rate2 - $score1_1 - $score1_2<br>";

													$sqlSco1_1 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$course}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail}' AND b.course_class_level_id = '$course_class_lid' AND c.course_s_id='{$courses_id}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid1}' AND a.grade_id = '{$check_grade}' AND a.term_id = '{$check_term}' AND a.score_type='1' AND a.score_no ='2' AND a.score_status='1' AND b.student_id='$student_id'";
													...
													//echo "$max_s-$sum_s-$rate1-$score1_1<br>";
														...
														//echo "$score11 - $rate1 : $score21 - $rate2<br>";
														...
														//echo "$score1 = $sum_maxs_1_1+$sum_maxs_1_2<br>";
														...
														//echo "$score2 = $sum_maxs_2_1+$sum_maxs_2_2<br><br>";
