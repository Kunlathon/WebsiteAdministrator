            ...
            <tbody>
				<tr>
                    <td  style="width: 690px;">
                        <div style="font-weight: bold; text-align: center; font-size: 15px;">แบบรายงานผลพัฒนาคุณภาพผู้เรียนรายบุคคล / Assessment Report, Secondary Level</div>
                        <div style="text-align: center; font-size: 15px;">โรงเรียนยุวฑูตศึกษาราชพฤกษ์ / Ambassador Bilingual Academy</div>
                        <div style="text-align: center; font-size: 15px;">การประเมินครั้งที่ 1 ภาคเรียนที่ <?php echo $term1;?> ปีการศึกษา <?php echo $year1;?> / 1<sup>st</sup> Assessment Semester <?php echo $term1;?> Academic Year <?php echo $year2;?></div>
        ...
        <table style="width: 690 px;" border="0" cellpadding="0" cellspacing="0">
            <tbody>
				<tr>
                    ...
                    <td style="font-size: 13px; width: 140px;" align="left"> ชื่อ - สกุล : </td>
                ...
                <tr>
					...
					<td style="font-size: 13px; width: 170px;" align="left">&nbsp;<?php echo $row['student_name_eng'];?>&nbsp;<?php echo $row['student_surname_eng'];?></td> 
					<td style="font-size: 13px; width: 69px;" align="left"> Grade :  </td>
					<td style="font-size: 13px; width: 69px;" align="left" align="left">&nbsp;G.<?php echo $class_name;?></td>
