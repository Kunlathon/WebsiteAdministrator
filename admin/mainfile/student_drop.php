            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="?modules=student_drop" class="breadcrumb-item"> นิสิต(ลาพัก)</a>

                        <a href="#" class="breadcrumb-item"> ข้อมูลนิสิต(ลาพัก)</a>
                    ...
                    <div class="col-<?php echo $grid; ?>-12">
                        <table>
                            <tr>
                                <td>
                                    <div>
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_drop';" class="btn btn-outline-success" value="">รายการ</button>
                                    </div>
                                </td>
                                <td>

                                    <div>
                                        <form name="form_show" id="form_show" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_drop">
                                ...
                                <td>
                                    <div>
                                        <form name="update_ta" id="update_ta" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_drop">
            ...
            <?php   } else { ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                <div class="col-<?php echo $grid; ?>-6">ตาราง ข้อมูลนิสิต(ลาพัก) </div>
                                <div class="col-<?php echo $grid; ?>-6" align="right">
                                    <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_drop';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                </div>
                            </div>
                                            ...
                                            <table class="table table-bordered datatable-button-html5-columns-STD">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($list as $key => $row) { ?>
                                                        ...
                                                        $date_in_th = new strto_datetime("th_year", @$row['date_in']);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if ((@$row['date_in'] == "" || @$row['date_in'] == "0000-00-00")) {
                                                                    ...
                                                                    $date_in_show = $txt_date_in->print_datetime();
                                                                }

                                                                ?>

                                                                <div><?php echo $date_in_show; ?></div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                if (@$row['date_in'] == "" || @$row['date_in'] == "0000-00-00") {
                                                                    ...
                                                                    $date_in_show = $date_in_th->print_datetime();
                                                                }
