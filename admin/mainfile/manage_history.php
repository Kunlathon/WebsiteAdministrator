            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_history" class="breadcrumb-item"> ประวัติศูนย์ภาษา (TH)</a>

                        <a href="#" class="breadcrumb-item"> รายละเอียดประวัติศูนย์ภาษา (TH)</a>
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <h4>ข้อมูลประวัติศูนย์ภาษา (TH)</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-4">
                        <div class="btn-group">
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_history'" class="btn btn-success btn-sm" value="">แก้ไข (TH)</button>&nbsp;&nbsp;
                    ...
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                <div class="col-<?php echo $grid; ?>-6">ฟอร์มแก้ไขข้อมูลประวัติศูนย์ภาษา (TH)</div>
    ...
    $(document).ready(function(){
        ...
        $('.file-input-custom').fileinput({
            ...
            initialPreviewConfig: [
                {
                    caption: copy_information_image,  
                    key: 1, 
                    //url:'{$url}',
                    showDrag: false
                }
