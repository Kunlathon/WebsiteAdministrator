...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
    ...
    <?php
        ...
        $manage="edit";
            if(($manage=="edit")){ 
                $sql = "SELECT information_topic,information_detail,information_image 
                        FROM `tb_information` 
        ...
        <div class="col-<?php echo $grid;?>-12">
            <div class="card border border-purple">
                <div class="card-header header-elements-inline bg-info text-white">
                    <div class="col-<?php echo $grid;?>-6">ฟอร์มแก้ไขข้อมูลประวัติศูนย์ภาษา</div>
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid;?>-12">
                            <fieldset class="mb-3">
                                <div class="form-group row">
                                    <div class="col-<?php echo $grid;?>-12">
                                        <input type="file" name="information_image" id="information_image" class="form-control" value="" placeholder="ภาพ">
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid;?>-12">
                            <fieldset class="mb-3">
                                <div class="form-group row">
                                    <div class="col-<?php echo $grid;?>-12">
                                        <textarea name="information_detail" id="editor-full" rows="4" cols="4">
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid; ?>-12">
                            <fieldset class="mb-3">
                                ...
                                <button type="reset" name="" id="" class="btn btn-danger">ยกเลิก</button>
                            </fieldset>
                        </div>
                    </div>
