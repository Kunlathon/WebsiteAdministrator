...
if ((preg_match("/user_data2.php/", $_SERVER['PHP_SELF']))) {
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="?modules=user_data2" class="breadcrumb-item"> ผู้ใช่งานระบบ(ออกแล้ว)</a>

                        <a href="#" class="breadcrumb-item"> ข้อมูลผู้ใช่งานระบบ(ออกแล้ว)</a>
                        ...
                        <div class="col-<?php echo $grid; ?>-12">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <div>
                                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2';" class="btn btn-outline-success" value="">รายการ</button>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            <form name="form_show" id="form_show" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2&list=<?php echo base64_encode('profile'); ?>&admin_key=<?php echo base64_encode(@$row['admin_id']); ?>">
                                    ...
                                    <td>
                                        <div>
                                            <form name="update_ta" id="update_ta" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2&manage=form_edit&admin_key=<?php echo base64_encode(@$row['admin_id']); ?>">
            ...
            <?php   } else { ?>
                            ...
                            <div class="card border border-purple">
                                <div class="card-header header-elements-inline bg-info text-white">
                                    ...
                                    <div class="col-<?php echo $grid; ?>-6" align="right">
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                        <!--<button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลผู้ใช่งานระบบ</button>-->
                                    </div>
                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-<?php echo $grid; ?>-9">
                                                                    <div id="password-null">
                                                                        <input type="text" name="password" id="password" class="form-control" value="" placeholder="กรอกข้อมูลชื่อผู้ใช่งาน" required="required">
                                                                        <span>กรอกข้อมูลรหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                ...
                <?php } elseif (($manage == "form_edit")) { ?>
                                                        ...
                                                        <div class="col-<?php echo $grid; ?>-12">
                                                            <fieldset class="mb-3">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-<?php echo $grid; ?>-9">
                                                                        <div id="username-null">
                                                                            <input type="text" name="username" id="username" class="form-control" value="<?php echo $row['admin_username']; ?>" placeholder="กรอกข้อมูลชื่อผู้ใช่งาน" required="required">
                                                                            <span>กรอกข้อมูลชื่อผู้ใช่งานต้องมีอย่างน้อย 6 ตัวอักษร</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <?php   } else {
                        ...
                        exit("<script>window.location='$linkcopy/?modules=user_data2';</script>");
                    }
                    ?>
                    <!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
                                        ...
                                        <form name="user_data_password" id="user_data_password" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-<?php echo $grid; ?>-8">
                                                                <div class="form-group form-group-feedback form-group-feedback-left">
                                                                    <input type="text" name="" id="" class="form-control form-control-lg" value="<?php echo @$row['admin_name']; ?> <?php echo @$row['admin_surname']; ?>" required="required" readonly="readonly">
                                            ...
                                            <div class="row">
                                                <div class="col-<?php echo $grid; ?>-12">
                                                    <fieldset class="mb-3">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-<?php echo $grid; ?>-4">User Name</label>
                                                            <div class="col-<?php echo $grid; ?>-8">
                                                                <div class="form-group form-group-feedback form-group-feedback-left">
                                                                    <input type="text" name="" id="" class="form-control form-control-lg" value="<?php echo @$row['admin_username']; ?>" required="required" readonly="readonly">
                                                                    <div class="form-control-feedback form-control-feedback-lg">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-<?php echo $grid; ?>-8">
                                                                <div id="password-pass">
                                                                    <div class="form-group form-group-feedback form-group-feedback-left">
                                                                        <input type="password" name="password" id="password" class="form-control form-control-lg" value="aba@123456" required="required">
                                            ...
                                            <div class="row">
                                                <div class="col-<?php echo $grid; ?>-12">
                                                    <fieldset class="mb-3" style="float: right">
                                                        <button type="button" name="password_user_data" id="password_user_data" class="btn btn-info" value="<?php echo @$row['admin_id']; ?>">บันทึก</button>&nbsp;
                ...
                <?php } else { ?>
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid; ?>-12">
                            <div class="card border border-purple">
                                <div class="card-header header-elements-inline bg-info text-white">
                                    <div class="col-<?php echo $grid; ?>-6">ตารางข้อมูลผู้ใช่งาน(ออกแล้ว)</div>
                                    <div class="col-<?php echo $grid; ?>-6" align="right">
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                        <!--<button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลผู้ใช่งานระบบ</button>-->
                                    </div>
                                            ...
                                            <form name="user_data_read" id="user_data_read" method="post" accept-charset="utf-8">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered datatable-button-html5-columns-STD">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql = "SELECT * FROM tb_admin WHERE (admin_username != 'admin' AND admin_username != 'snaper') AND admin_work='0' ORDER BY admin_name ASC";
                        ...
                        $rowS= row_array($sqlS);*/
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 18%;">
                                                                        <div align="center">
                                                                            <button type="button" name="" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2&manage=password&admin_key=<?php echo base64_encode(@$row['admin_id']); ?>';" class="btn btn-outline-warning btn-sm" data-popup="tooltip" title="เปลี่ยนรหัสผ่าน" data-placement="bottom" value=""><i class="icon-key"></i></button>

                                                                            <button type="button" name="ShowUser_data" id="ShowUser_data" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2&list=<?php echo base64_encode('profile'); ?>&admin_key=<?php echo base64_encode(@$row['admin_id']); ?>';" class="btn btn-outline-primary btn-sm" data-popup="tooltip" title="รายละเอียด" data-placement="bottom" value="<?php echo @$row['admin_id']; ?>"><i class="icon-search4"></i></button>

                                                                            <button type="button" name="Upuser_data" id="Upuser_data" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2&manage=form_edit&admin_key=<?php echo base64_encode(@$row['admin_id']); ?>';" class="btn btn-outline-secondary btn-sm" data-popup="tooltip" title="แก้ไข" data-placement="bottom" value="<?php echo @$row['student_id']; ?>"><i class="icon-pen"></i></button>
                                                                                                                ...
                                                                                                                if (process_add.trim() === "no_error") {
                                                                                                                    ...
                                                                                                                    swalInitDeleteUserData.fire({
                                                                                                                        ...
                                                                                                                        if (result.dismiss === Swal.DismissReason.timer) {
                                                                                                                            document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=user_data2";
                                                                                                                        } else {}
                                                                                                                    });
