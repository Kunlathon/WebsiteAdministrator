            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_cn" class="breadcrumb-item"> โครงสร้างองค์กร และคณะกรรมการ (CN)</a>

                        <a href="#" class="breadcrumb-item"> รายละเอียดโครงสร้างองค์กร และคณะกรรมการ (CN)</a>
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <h4>ข้อมูลโครงสร้างองค์กร และคณะกรรมการ (CN)</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-4">
                        <div class="btn-group">
                            ...
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_en'" class="btn btn-outline-success btn-sm" value="">แก้ไข (EN)</button>&nbsp;&nbsp;
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_cn'" class="btn btn-success btn-sm" value="">แก้ไข (CN)</button>
                        </div>
                    </div>
                    ...
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                <div class="col-<?php echo $grid; ?>-6">ฟอร์มแก้ไขข้อมูลโครงสร้างองค์กร และคณะกรรมการ (CN)</div>
                                <div class="col-<?php echo $grid; ?>-6">
                                    <table align="right">
                                        <tr>
                                            <td>
                                                <div>
                                                    <form name="manage_organization_form_show" id="manage_organization_form_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_cn">
                            ...
                            <div class="card-body">
                                <form name="form_edit" id="form_edit" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System(); ?>/js_code/manage_organization_cn/manage_organization_cn_process.php" method="post" enctype="multipart/form-data">
