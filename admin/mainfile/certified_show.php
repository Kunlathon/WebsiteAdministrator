...
error_reporting(E_ALL ^ E_NOTICE);
    if((preg_match("/certified_show.php/", $_SERVER['PHP_SELF']))) {
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo $RunLink->Call_Link_System(); ?>/?modules=certified_show" class="breadcrumb-item"> ข้อมูลขอใบรับรองออนไลน์</a>

                        <a href="#" class="breadcrumb-item">   ข้อมูลขอเอกสารรับรอง</a>
            ...
            <div class="col-<?php echo $grid;?>-12">
                <div class="card border border-purple">
                    <div class="card-header header-elements-inline bg-info text-white">
                        <div class="col-<?php echo $grid;?>-6">ตาราง ข้อมูลขอเอกสารรับรอง</div>
