...
?>
    <?php
        if((preg_match("/report_achievemrnt_update.php/", $_SERVER['PHP_SELF']))){
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="<?php echo $RunLink->Call_Link_System();?>/?modules=report_achievement_update" class="breadcrumb-item">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-<?php echo $grid;?>-12">
                <h4> ปรับปรุงผลสัมฤทธิ์ทางการศึกษา</h4>
            </div>
        </div>
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
        ...
        <div class="row">
            <div class="col-<?php echo $grid;?>-4">
                <div style="font-size: 18px;" >ผลสัมฤทธิ์ทางการศึกษา</div>    
            </div>
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
                        <div class="col-<?php echo $grid; ?>-4">
<form name="list_class<?php echo $count_color;?>" id="list_class<?php echo $count_color;?>" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=report_achievement_update">
