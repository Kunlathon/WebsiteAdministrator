...
if ((preg_match("/student_data2.php/", $_SERVER['PHP_SELF']))) {
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="?modules=student_data2" class="breadcrumb-item"> นิสิตระดับมัธยมศึกษาตอนต้น</a>

                        <a href="#" class="breadcrumb-item"> ข้อมูลนิสิตระดับมัธยมศึกษาตอนต้น</a>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-<?php echo $grid; ?>-4">
                    <h4>ข้อมูลนิสิตระดับมัธยมศึกษาตอนต้น</h4>
                </div>
                    ...
                    <div class="col-<?php echo $grid; ?>-12">
                        <table>
                            <tr>
                                <td>
                                    <div>
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2&classroom=<?php echo base64_encode($classroom_id); ?>';" class="btn btn-outline-success" value="">รายการ</button>
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <form name="form_show" id="form_show" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2&manage=profile&student_key=<?php echo base64_encode($row['student_id']); ?>&classroom=<?php echo base64_encode($classroom_id); ?>">
                                ...
                                <td>
                                    <div>
                                        <form name="update_ta" id="update_ta" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2&manage=form_edit&student_key=<?php echo base64_encode($row['student_id']); ?>&classroom=<?php echo base64_encode($classroom_id); ?>">
                        ...
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                ...
                                <div class="col-<?php echo $grid; ?>-6" align="right">
                                    ...
                                    <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลนิสิต</button>
                                </div>
                            </div>
            ...
            <?php   } elseif (($manage == "form_edit")) { ?>
                ...
                <?php   } else {
                    ...
                    exit("<script>window.location='$linkcopy/?modules=student_data2';</script>");
                } ?>
                                                        ...
                                                        <?php foreach ($list as $key => $row) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 18%;" align="center">
                                                                    <div align="center">
                                                                        <button type="button" name="" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2&manage=password&student_key=<?php echo base64_encode($row['student_id']); ?>';" class="btn btn-outline-warning btn-sm" data-popup="tooltip" title="เปลี่ยนรหัสผ่าน" data-placement="bottom" value=""><i class="icon-key"></i></button>
                                                                        <button type="button" name="button_show" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2&manage=profile&student_key=<?php echo base64_encode($row['student_id']); ?>&classroom=<?php echo base64_encode($row['classroom_id']); ?>';" class="btn btn-outline-primary btn-sm" data-popup="tooltip" title="รายละเอียด" data-placement="bottom"><i class="icon-search4"></i></button>
                                                                        <button type="button" name="Up_Student_Data" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2&manage=form_edit&student_key=<?php echo base64_encode($row['student_id']); ?>&classroom=<?php echo base64_encode($row['classroom_id']); ?>';" class="btn btn-outline-secondary btn-sm" data-popup="tooltip" title="แก้ไข" data-placement="bottom" value="<?php echo $row['student_id']; ?>"><i class="icon-pen"></i></button>
                                                                                        ...
                                                                                        var _componentABA_DeleteStudentData = function() {
                                                                                            ...
                                                                                            $('#delete_<?php echo $row['student_id']; ?>').on('click', function() {
                                                                                                ...
                                                                                                if (action == "") {
                                                                                                    ...
                                                                                                    if (id != "") {
                                                                                                        $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/student_data2/student_data2_process.php", {
                                                                                                            action: action,
                                                                                                            table: table,
                                                                                                            ff: ff,
                                                                                                            id: id
                                                                                                            ...
                                                                                                            if (process_add.trim() === "no_error") {
                                                                                                                ...
                                                                                                                swalInitDeleteStudentData.fire({
                                                                                                                    ...
                                                                                                                    if (result.dismiss === Swal.DismissReason.timer) {
                                                                                                                        document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_data2";
                                                                                                                    } else {}
                                                                                                                });
