...
if ((preg_match("/student_success.php/", $_SERVER['PHP_SELF']))) {
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="?modules=student_success" class="breadcrumb-item"> นิสิตที่สำเร็จการศึกษา</a>

                        <a href="#" class="breadcrumb-item"> ข้อมูลนิสิตที่สำเร็จการศึกษา</a>
        ...
        <div class="content">
            <div class="row">
                <div class="col-<?php echo $grid; ?>-12">
                    <h4>ข้อมูลนิสิตที่สำเร็จการศึกษา</h4>
                </div>
            </div>
            ...
            if (($manage == "profile")) { ?>
                    ...
                    <div class="col-<?php echo $grid; ?>-12">
                        <table>
                            <tr>
                                <td>
                                    <div>
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success';" class="btn btn-outline-success" value="">รายการ</button>
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <form name="form_show" id="form_show" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success">
                                ...
                                <td>
                                    <div>
                                        <form name="update_ta" id="update_ta" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success">
                        ...
                        <div class="card border border-info">
                            <div class="card-header header-elements-inline bg-info text-white">
                                ...
                                <div class="col-<?php echo $grid; ?>-6" align="right">
                                    <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                </div>
                            </div>
                ...
                <!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
            <?php   } elseif (($manage == "insert_student")) { ?>
                <?php
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-<?php echo $grid; ?>-12">
                                        <fieldset class="mb-3">
                                            <div class="form-group row">
                                                <button type="button" name="Add_Student_Success" id="Add_Student_Success" class="btn btn-info" value="">บันทึก</button>&nbsp;

                                                <form name="man_stu" id="man_stu" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success" accept-charset="utf-8">
                                                    <button type="submit" class="btn btn-danger">ยกเลิก</button>
                                                    <input type="hidden" name="manage" id="manage" value="insert_student">
            ...
            <?php   } elseif (($manage == "form_edit")) { ?>
                        ...
                        <div class="col-<?php echo $grid; ?>-12">
                            <div class="card border border-purple">
                                <div class="card-header header-elements-inline bg-info text-white">
                                    ...
                                    <div class="col-<?php echo $grid; ?>-6" align="right">
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                        <!-- <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลนิสิต</button> -->
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-<?php echo $grid; ?>-12">
                                            <form name="student_success_edit" id="student_success_edit">
                                                <div class="row">
                                                    <div class="col-<?php echo $grid; ?>-12">
                                                        <fieldset class="mb-3">
                                                            <div class="form-group row">
                                                ...
                                                <div class="row">
                                                    <div class="col-<?php echo $grid; ?>-12">
                                                        <fieldset class="mb-3">
                                                            <div class="form-group row">
                                                                <button type="button" name="edit_student_success" id="edit_student_success" class="btn btn-info">บันทึก</button>&nbsp;
                ...
                <?php   } else {
                    ...
                    exit("<script>window.location='$linkcopy/?modules=student_success';</script>");
                } ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered datatable-button-html5-columns-STD">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                        $sql = "SELECT * FROM `tb_student` WHERE `student_status`='3' ORDER BY `year_term` DESC , `student_name` ASC";
                                                        ...
                                                        <?php foreach ($list as $key => $row) { ?>
                                                            ...
                                                            <?php
                                                            if (@$row['birth_day'] == null or @$row['birth_day'] == "0000-00-00") {
                                                                $birth_day = null;
                                                            } else {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <ul class="nav">
                                                                        <li class="nav-item">
                                                                            <form name="drop_data_up<?php echo @$row['student_id']; ?>" id="drop_data_up<?php echo @$row['student_id']; ?>" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success" accept-charset="utf-8">
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <form name="man_stu<?php echo @$row['student_id']; ?>" id="man_stu<?php echo @$row['student_id']; ?>" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=student_success" accept-charset="utf-8">
