                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-body">
                                ...
                                if (isset($_REQUEST['check_term'])) {
                                    ...
                                    $sql = "SELECT * FROM tb_term a INNER JOIN tb_term_detail b ON a.term_id = b.term_id  WHERE a.term_id = '{$check_term}' AND a.grade_id = '{$check_grade}' ORDER BY a.year DESC , a.term DESC";
                                    $row = row_array($sql);
                                    $term1 = "$row[term]";
                                    $year1 = "$row[year]";
                                    $year2 = $year1 - 543;
                                    ...
                                    $sql = "SELECT * FROM tb_term a INNER JOIN tb_term_detail b ON a.term_id = b.term_id WHERE a.grade_id = '{$check_grade}' AND  a.term_status = '1' ORDER BY a.year DESC , a.term DESC";
                                    $row = row_array($sql);
                        ...
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>รายละเอียดผลคะแนน ครั้งที่ 1</span>
                            </li>
                        </ul>
                                            ...
                                            <div class="col-md-12" align="center">
                                                <label class="col-md-12 control-label">
                                                    ...
                                                    <strong>โรงเรียนยุวฑูตศึกษาราชพฤกษ์ / Ambassador Bilingual Academy<br>
                                                        การประเมินครั้งที่ 1 ภาคเรียนที่ <?php echo $term1; ?> ปีการศึกษา <?php echo $year1; ?> / 1<sup>st</sup> Assessment Semester <?php echo $term1; ?> Academic Year <?php echo $year2; ?></strong><br>
                                                                                ...
                                                                                <table class="table table-striped table-hover">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        ?>
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <font size="2"><?php echo $key1; ?></font>
                                                                                                    </td>
                                                                                                    <!--<td align="center"><?php echo $key + 1; ?></td>-->
                                                                                                    <td align="center">
                                                                                                        <font size="2"><?php echo  $row['subject_code']; ?></font>
                                                                                                    </td>
                                                                                                    ...
                                                                                                    ?>
                                                                                                    <td align="center">
                                                                                                        <font size="2"><?php echo number_format($score1, 0); ?></font>
                                                                                                    </td>
                                                                                                    <td align="center">
                                                                                                        <font size="2"><?php echo number_format($score2, 0); ?></font>
                                                                                                    </td>
                                                                                                    <?php
                                                                                                    $score1 = $score1;
                                                                                                    $score2 = $score2;
                                                                                                    ...
                                                                                                    ?>
                                                                                                    <td align="center">
                                                                                                        <font size="2"><?php echo  number_format($max_sum, 0); ?></font>
                                                                                                    </td>
                                                                                                    <td align="center">
                                                                                                        <font size="2">(<?php echo $score1_1; ?>:<?php echo $score1_2; ?>)</font>
                                                                                                    </td>
                                                                                                </tr>
                                                                                        <?php
                                                                                                $score1 = 0;
                                                                                                ...
                                                                                                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                                                                                    <tr bgcolor="#dcdcdc">
                                                                                                        <td align="center" colspan="3"><strong>
                                                                                                                <font size="2">กิจกรรมพัฒนาผู้เรียน / Learner Development Activities</font>
                                                                                                            </strong></td>
                                                                                                    </tr>
                                                                                                ...
                                                                                                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                                                                                    <tr bgcolor="#dcdcdc">
                                                                                                        <td align="center" colspan="2"><strong>
                                                                                                                <font size="2">การประเมินคุณลักษณะ / Character Evaluation</font>
                                                                                                            </strong></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td align="left">
                                                                                                            <font size="2">คุณลักษณะอันพึงประสงค์ของสถานศึกษา / Desirable characteristics<br>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="left">
                                                                                                            <font size="2">การอ่าน คิด วิเคราะห์และเขียน / Capacity for communication,<br>
                                                                                                                thinking, problem-solving and applying life skills</font>
                                                                                                        </td>
                                                                                                        <td align="center" width="80">
                                                                                                            <font size="2">N/A</font>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="left">
                                                                                                            <font size="2">กิจกรรมพัฒนาผู้เรียน / Student activities</font>
                                                                                                        </td>
                                                                                                        <td align="center" width="80">
                                                                                                            <font size="2">N/A</font>
                                                                                                        </td>
