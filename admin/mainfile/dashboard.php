						...
						<div class="card card-body bg-info text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count1_register1" class="count-up" data-value="<?php echo $count1_register1; ?>"><?php echo $count1_register1; ?></font></span>
								</div>
							</div>
						</div>
					</a>
						...
						<div class="card card-body bg-yellow text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count2_register_pass1" class="count-up" data-value="<?php echo $count2_register_pass1; ?>"><?php echo $count2_register_pass1; ?></font></span>
								</div>
							</div>
						</div>
					</a>
						...
						<div class="card card-body bg-danger text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count3_register_unpass1" class="count-up" data-value="<?php echo $count3_register_unpass1; ?>"><?php echo $count3_register_unpass1; ?></font></span>
								</div>
							</div>
						</div>
					</a>
						...
						<div class="card card-body bg-primary text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count_student1" class="count-up" data-value="<?php echo $count_student1; ?>"><?php echo $count_student1; ?></font></span>
								</div>
							</div>
						</div>
					</a>
						...
						<div class="card card-body bg-primary text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count_studentcard1" class="count-up" data-value="<?php echo $count_studentcard1; ?>"><?php echo $count_studentcard1; ?></font></span>
								</div>
							</div>
						</div>
					</a>
						...
						<div class="card card-body bg-success text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count_studentcard2" class="count-up" data-value="<?php echo $count_studentcard2; ?>"><?php echo $count_studentcard2; ?></font></span>
								</div>
							</div>
						</div>
					</a>
						...
						<div class="card card-body bg-purple  text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count_certified1" class="count-up" data-value="<?php echo $count_certified1; ?>"><?php echo $count_certified1; ?></font></span>
								</div>
							</div>
						</div>
					</a>
						...
						<div class="card card-body bg-warning text-white has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									...
									<span class="text-uppercase font-size-xs" style="font-size: 20px;"><font id="cu-count_certified2" class="count-up" data-value="<?php echo $count_certified2; ?>"><?php echo $count_certified2; ?></font></span>
								</div>
							</div>
						</div>
					</a>
