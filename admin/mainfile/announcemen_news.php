<?php
    ...
    if ((preg_match("/announcemen_news.php/", $_SERVER['PHP_SELF']))) {
                ...
                <div class="col-<?php echo $grid;?>-12">
                    <div class="card border border-purple">
                        <div class="card-header header-elements-inline bg-info text-white">
                            <div class="col-<?php echo $grid;?>-6">ฟอร์มเพิ่มข้อมูลข่าวประกาศ</div>
                            <div class="col-<?php echo $grid;?>-6">
                                <table align="right">
                                    <tr>
                                        <td>
                                            <div>
    <form name="form_announcemen_news_show" id="form_announcemen_news_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=announcemen_news">
                        ...
                        <div class="card-body">
<form name="form_add" id="form_add" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System();?>/js_code/announcemen_news/announcemen_news_process.php" method="post" enctype="multipart/form-data">
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
            ...
            <div class="row">
                <div class="col-<?php echo $grid;?>-12">
                    <div class="card border border-purple">
                        <div class="card-header header-elements-inline bg-info text-white">
                            <div class="col-<?php echo $grid;?>-6">ฟอร์มแก้ไขข้อมูลข่าวประกาศ</div>
                            <div class="col-<?php echo $grid;?>-6">
                                <table align="right">
                                    <tr>
                                        <td>
    ...
    <form name="form_announcemen_news_show" id="form_announcemen_news_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=announcemen_news">
                        ...
                        <div class="card-body">
<form name="form_up" id="form_up" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System();?>/js_code/announcemen_news/announcemen_news_process.php" method="post" enctype="multipart/form-data">
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
        ...
        <div class="row">
            <div class="col-<?php echo $grid;?>-12">
                <div class="card border border-purple">
                    <div class="card-header header-elements-inline bg-info text-white">
                        <div class="col-<?php echo $grid;?>-6">ข้อมูลข่าวประกาศทั้งหมด</div>
                        <div class="col-<?php echo $grid;?>-6">
                            <table align="right">
                                <tr>
                                    <td>
...
<form name="form_announcemen_news_show" id="form_announcemen_news_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=announcemen_news">
                                    ...
                                    <td>
                                        <div>
<form name="form_announcemen_news_add" id="form_announcemen_news_add" accept-charset="utf-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=announcemen_news">
                                            <input type="hidden" name="manage" id="manage" value="add">
                                            <button type="submit" name="sub_mva" id="sub_mva"  class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลข่าวประกาศ</button>
</form>
                                        </div>
                                    </td>
                                </tr>
