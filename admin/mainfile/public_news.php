<?php
    ...
    if ((preg_match("/public_news.php/", $_SERVER['PHP_SELF']))) {
                            ...
                            <div class="col-<?php echo $grid;?>-6">
                                <table align="right">
                                    <tr>
                                        <td>
                                            <div>
    <form name="form_public_news_show" id="form_public_news_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=public_news">
                        ...
                        <div class="card-body">
<form name="form_add" id="form_add" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System();?>/js_code/public_news/public_news_process.php" method="post" enctype="multipart/form-data">
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
    ...
    <form name="form_public_news_show" id="form_public_news_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=public_news">
                        ...
                        <div class="card-body">
<form name="form_up" id="form_up" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System();?>/js_code/public_news/public_news_process.php" method="post" enctype="multipart/form-data">
...
<form name="form_public_news_show" id="form_public_news_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=public_news">
                                    ...
                                    <td>
                                        <div>
<form name="form_public_news_add" id="form_public_news_add" accept-charset="utf-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=public_news">
