                            ...
                            if ((isset($id, $classroom, $check_grade, $check_term))) { ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12" align="center">
                                        ...
                                        <div><strong>แบบรายงานผลพัฒนาคุณภาพผู้เรียนรายบุคคล / Assessment Report, Secondary Level</strong></div>
                                        <div><strong>โรงเรียนยุวฑูตศึกษาราชพฤกษ์ / Ambassador Bilingual Academy</strong></div>
                                        <div><strong>การประเมินครั้งที่ 2 ภาคเรียนที่ <?php echo $term1; ?> ปีการศึกษา <?php echo $year1; ?> / 2<sup>nd</sup> Assessment Semester <?php echo $term1; ?> Academic Year <?php echo $year2; ?></strong></div>
<?php
...
?>
                                        <div><strong>ชั้นมัธยมศึกษาปีที่ <?php echo class_status($txt_grade); ?> / Grade <?php echo $txt_grade; ?></strong></div>
                                    </div>
                                </div>
                                                                            ...
                                                                            <table class="table table-striped table-hover">
                                                                                <thead>
                                                                                    <tr bgcolor="#dcdcdc">
                                                                                        ...
                                                                                        <th width="120"> คะแนนเก็บตามตัวชี้วัด <br>Standards Score </th>
                                                                                        <th width="120"> คะแนนสอบ <br>Test Score </th>
                                                                                        <th width="120"> คะแนนรวม/Total <br>100% </th>
                                                                                        <th width="120"> สัดส่วนคะแนน <br> Ratio </th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    <?php
