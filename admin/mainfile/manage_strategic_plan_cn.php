            ...
            ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <h4>ข้อมูลแผนยุทธศาสตร์ & เป้าหมาย (CN)</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-4">
                        <div class="btn-group">
                            ...
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_strategic_plan_cn'" class="btn btn-success btn-sm" value="">แก้ไข (CN)</button>
                        </div>
                    </div>
                    ...
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                <div class="col-<?php echo $grid; ?>-6">ฟอร์มแก้ไขข้อมูลแผนยุทธศาสตร์ & เป้าหมาย (CN)</div>
                                <div class="col-<?php echo $grid; ?>-6">
                                    <table align="right">
                                        <tr>
                                            <td>
                                                <div>
                                                    <form name="manage_strategic_plan_form_show" id="manage_strategic_plan_form_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_strategic_plan_cn">
                            ...
                            <div class="card-body">
                                <form name="form_edit" id="form_edit" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System(); ?>/js_code/manage_strategic_plan_cn/manage_strategic_plan_cn_process.php" method="post" enctype="multipart/form-data">
