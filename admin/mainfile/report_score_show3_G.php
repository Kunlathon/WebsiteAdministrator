                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        ...
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="?modules=report_score_3&classroom=<?php echo $classroom; ?>&check_grade=<?php echo $check_grade; ?>&check_term=<?php echo $check_term; ?>">ผลคะแนนระดับมัธยมศึกษา</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>GPA</span>
                                                                            ...
                                                                            <table class="table table-striped table-hover">
                                                                                <thead>
                                                                                    <tr bgcolor="#dcdcdc">
                                                                                        ...
                                                                                        <th width="180"> ประเภท <br>Category</th>
                                                                                        <th width="120"> หน่วยกิต <br>Credit</th>
                                                                                        ...
                                                                                        <td align="left" colspan="4">
                                                                                            ...
                                                                                            <table class="table table-striped table-hover">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center" width="80"><?php echo number_format($total_subweight1, 1); ?></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center" width="80"><?php echo number_format($total_subweight3, 1); ?></td>
                                                                                                </tr>
