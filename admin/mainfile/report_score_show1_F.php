                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12" align="center">
                                                <label class="col-md-12 control-label">
                                                    <br>
                                                    <strong>แบบรายงานผลพัฒนาคุณภาพผู้เรียนรายบุคคล / Assessment Report, Primary Level<br>
                                                        โรงเรียนยุวฑูตศึกษาราชพฤกษ์ / Ambassador Bilingual Academy<br>
                                                        การประเมินผลสัมฤทธิ์ ภาคเรียนที่ <?php echo $term1; ?> ปีการศึกษา <?php echo $year1; ?> / Assessment Academic Year <?php echo $term1; ?>/<?php echo $year2; ?></strong><br>
                                                                            ...
                                                                            <!--<div class="table-scrollable">-->
                                                                                <table class="table table-striped table-hover">
                                                                                    <thead>
                                                                                        ...
                                                                                        <tr bgcolor="#dcdcdc">
                                                                                            <th width="80">
                                                                                                <font size="2">การประเมิน ครั้งที่ 1<sup>st</sup><br>1 Eval.</font>
                                                                                            </th>
                                                                                            <th width="80">
                                                                                                <font size="2">การประเมิน ครั้งที่ 2<sup>nd</sup><br>2 Eval.</font>
                                                                                            </th>
                                                                                            <th width="80">
                                                                                                <font size="2">คะแนนรวม/Total <br>100% </font>
                                                                                            </th>
                                                                                            <th width="80">
                                                                                                <font size="2">ผลการเรียน <br>Grade
                                                                                            </th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody>
                                                                                        ...
                                                                                        ?>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    //echo "<br> $courses_id  -  $coursedetail  -- $subid - $course_class_lid ครั้งที่ 1<br>";
                                                                                                    ...
                                                                                                    if ($teacherid1 != "" && ($teacherid2 == "" || $teacherid2 == '0')) {
                                                                                                        ...
                                                                                                        //echo "ครั้งที่ 1 T1 <br>$rate1 - $rate2 - $score1_1 - $score1_2<br>";
                                                                                                    ...
                                                                                                    //echo "<br> $courses_id  -  $coursedetail  -- $subid - $course_class_lid ครั้งที่ 2<br><br>";
                                                                                                    ...
                                                                                                    if ($teacherid12 != "" && ($teacherid22 == "" || $teacherid22 == '0')) {
                                                                                                        ...
                                                                                                        foreach ($list12 as $key => $rowSco12) {
                                                                                                            ...
                                                                                                            $sqlSco22 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$course}' AND b.course_class_detail_id='{$coursedetail}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid12}' AND a.grade_id = '{$check_grade}' AND a.term_id = '{$check_term}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id' AND b.score!='0'";
                                                                                                        ...
                                                                                                        //echo "ครั้งที่ 2 T1 <br>$rate12 - $rate22 - $score1_12 - $score1_22<br>";

                                                                                                        $sqlSco1_12 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$course}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid12}' AND a.grade_id = '{$check_grade}' AND a.term_id = '{$check_term}' AND a.score_type='1' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
                                                                                                        ...
                                                                                                        foreach ($list1_12 as $key => $rowSco1_12) {
                                                                                                            ...
                                                                                                            $sqlSco1_22 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$course}' AND b.score!='0' AND b.course_class_detail_id='{$coursedetail}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid12}' AND a.grade_id = '{$check_grade}' AND a.term_id = '{$check_term}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
                                                                                                        ...
                                                                                                        //echo "ครั้งที่ 2 T2<br><br>";

                                                                                                        $sqlSco2_12 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$course}' AND b.course_class_detail_id='{$coursedetail}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid22}' AND a.grade_id = '{$check_grade}' AND a.term_id = '{$check_term}' AND a.score_type='1' AND a.score_no ='2' AND a.score_status='1' AND b.student_id='$student_id'";
                                                                                                        ...
                                                                                                        foreach ($list2_12 as $key => $rowSco2_12) {
                                                                                                            ...
                                                                                                            $sqlSco2_22 = "SELECT * FROM tb_score a INNER JOIN tb_score_detail b ON a.score_id=b.score_id INNER JOIN tb_course_student c ON b.course_s_id=c.course_s_id INNER JOIN tb_course_class_detail d ON b.course_class_detail_id=d.course_class_detail_id WHERE a.course_class_id='{$course}' AND b.course_class_detail_id='{$coursedetail}' AND b.course_class_level_id = '$course_class_lid2' AND c.course_s_id='{$courses_id}' AND d.subject_id ='{$subid}' AND a.teacher_id = '{$teacherid22}' AND a.grade_id = '{$check_grade}' AND a.term_id = '{$check_term}' AND a.score_type='2' AND a.score_status='1' AND a.score_no ='2' AND b.student_id='$student_id'";
