            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_en" class="breadcrumb-item"> โครงสร้างองค์กร และคณะกรรมการ (EN)</a>

                        <a href="#" class="breadcrumb-item"> รายละเอียดโครงสร้างองค์กร และคณะกรรมการ (EN)</a>
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <h4>ข้อมูลโครงสร้างองค์กร และคณะกรรมการ (EN)</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-4">
                        <div class="btn-group">
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization'" class="btn btn-outline-success btn-sm" value="">แก้ไข (TH)</button>&nbsp;&nbsp;
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_en'" class="btn btn-success btn-sm" value="">แก้ไข (EN)</button>&nbsp;&nbsp;
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_cn'" class="btn btn-outline-success btn-sm" value="">แก้ไข (CN)</button>
                        </div>
                    </div>
                    ...
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                <div class="col-<?php echo $grid; ?>-6">ฟอร์มแก้ไขข้อมูลโครงสร้างองค์กร และคณะกรรมการ (EN)</div>
                                <div class="col-<?php echo $grid; ?>-6">
                                    <table align="right">
                                        <tr>
                                            <td>
                                                <div>
                                                    <form name="manage_organization_form_show" id="manage_organization_form_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_organization_en">
                            ...
                            <div class="card-body">
                                <form name="form_edit" id="form_edit" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System(); ?>/js_code/manage_organization_en/manage_organization_en_process.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid; ?>-6">
                            <fieldset class="mb-3">
                                <div class="form-group row">
                                    <div class="col-<?php echo $grid; ?>-12">
                                        <input type="file" name="information_image" class="summernote" class="form-control"  placeholder="ภาพ" readonly="readonly">
                                    </div>
                                </div>
                            </fieldset>
                        </div>                        
