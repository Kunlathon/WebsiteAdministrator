...
?>
    <?php
        if((preg_match("/report_achievemrnt_edu.php/", $_SERVER['PHP_SELF']))){
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="<?php echo $RunLink->Call_Link_System();?>/?modules=report_achievement_edu" class="breadcrumb-item">
