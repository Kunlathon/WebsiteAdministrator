<?php
    ...
    if ((preg_match("/course_classroom_classroom_data.php/", $_SERVER['PHP_SELF']))) {
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="<?php echo $RunLink->Call_Link_System(); ?>/?modules=course_classroom_data" class="breadcrumb-item"> ห้องเรียน </a>
                            ...
                            <div class="col-<?php echo $grid;?>-6">
                                <table align="right">
                                    <tr>
                                        <td>
                                            <div>
    <form name="course_classroom_form_show" id="course_classroom_form_show" accept-charset="uft-8" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=course_classroom_data">
