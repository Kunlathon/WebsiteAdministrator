            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_director" class="breadcrumb-item"> สารจากผู้บริหาร (TH)</a>

                        <a href="#" class="breadcrumb-item"> รายละเอียดสารจากผู้บริหาร (TH)</a>
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-4">
                        <div class="btn-group">
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=manage_director'" class="btn btn-success btn-sm" value="">แก้ไข (TH)</button>&nbsp;&nbsp;
