...
error_reporting(E_ALL ^ E_NOTICE);
    if((preg_match("/assessment_data.php/", $_SERVER['PHP_SELF']))) {
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="?modules=subject_data" class="breadcrumb-item"> แบบประเมิน</a>

                        <a href="#" class="breadcrumb-item"> ประเมินนิสิต(ครูต่างประเทศ)</a>
        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-<?php echo $grid; ?>-12">
                    <h4>ประเมินนิสิต(ครูต่างประเทศ)</h4>
                </div>
            </div>

<?php
    $manage="-";
        if(($manage=="assessment_data_show")){
        ...
        <script>
            $(document).ready(function(){
                $('#button_class<?php echo $class_Print["grade_id"];?>').on('click',function(){
                    ...
                    var cp_class_gn="<?php echo $class_Print["grade_name"];?>";
                    var manage="read";
                    $.post("<?php echo $RunLink->Call_Link_System();?>/js_code/assessment_data/assessment_data_show.php",{
                        class_id:cp_class,
