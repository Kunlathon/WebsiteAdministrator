<?php
    ...
    if((preg_match("/assessment_show.php/", $_SERVER['PHP_SELF']))){
        Header("Location: ../index.php");
        die();
    }else{
        if((check_session("admin_status_lcm")=='1') or (check_session("admin_status_lcm") == '2') or (check_session("admin_status_lcm") == '3') or (check_session("admin_status_lcm") == '4') or (check_session("admin_status_lcm") == '5')){ ?>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="<?php echo $RunLink->Call_Link_System();?>/?modules=assessment_show" class="breadcrumb-item">
    ...
    <?php
      ...
      //  $grade_key="";         $check_grade;->check_grade
        ...
        //echo $a_classroom_key."<br>".$term_key."<br>".$grade_key."<br>-------";
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
													<tr>
														...
														<th > &nbsp; </th>
														<?php
															$sqlSco_1 = "SELECT *,COUNT(assessment_id) AS CC1 FROM tb_assessment a INNER JOIN tb_assessment_category b ON a.assessment_cat_id=b.assessment_cat_id WHERE (a.assessment_cat_id = '2') GROUP BY a.assessment_cat_id ASC ORDER BY a.assessment_cat_id ASC, a.assessment_sort ASC ";

															//echo $sqlSco_1;
															$rowSco_1 = row_array($sqlSco_1);
														?>
														
														<th  colspan="<?php echo $rowSco_1['CC1'];?>" align="center" bgcolor="#ccf4fd">
															<?php echo $rowSco_1['assessment_cat_name'];?>
														
														</th>

														<?php
															$sqlSco_2 = "SELECT * ,COUNT(assessment_id) AS CC2 FROM tb_assessment a INNER JOIN tb_assessment_category b ON a.assessment_cat_id=b.assessment_cat_id WHERE (a.assessment_cat_id = '3') ORDER BY a.assessment_cat_id ASC, a.assessment_sort ASC ";

															//echo $sqlSco_2;
															$rowSco_2 = row_array($sqlSco_2);
														?>
														
														<th  colspan="<?php echo $rowSco_2['CC2'];?>" align="center" bgcolor="#fcfdbf">
															<?php echo $rowSco_2['assessment_cat_name'];?>
                                                     ...
                                                     <tr>
														...
														<th > ชื่อเล่น </th>
														<?php
															$sqlSco_1 = "SELECT * FROM tb_assessment a INNER JOIN tb_assessment_category b ON a.assessment_cat_id=b.assessment_cat_id WHERE (a.assessment_cat_id = '2')  ORDER BY a.assessment_cat_id ASC, a.assessment_sort ASC";
														...
														?>
														<th  align="center" bgcolor="#ccf4fd">
															
                                                            <!--<a href="ajax/get_addrate.php?id=<?php echo $_rowSco_1['assessment_id'];?>&clid=<?php echo $cid;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>&type=1&ctid=<?php echo $ctid;?>" data-toggle="modal" data-id="<?php echo $_rowSco_1['assessment_id'];?>" data-target="#AddRate" class="btn btn-sm blue" title="<?php echo $_rowSco_1['assessment_sort'];?>.&nbsp;<?php echo $_rowSco_1['assessment_name'];?>">
																<i class="fa fa-file-text-o"></i> </a>-->
														
                                                                <div><a  title="<?php echo $_rowSco_1['assessment_sort'];?>.&nbsp;<?php echo $_rowSco_1['assessment_name'];?>" class="badge badge-primary p-1" data-toggle="modal" data-target="#AddRateA<?php echo $_rowSco_1['assessment_id'];?>" ><i class="icon-file-text3"></i></a></div>
														</th>
														<?php } ?>
														...
														<?php
															$sqlSco_2 = "SELECT * FROM tb_assessment a INNER JOIN tb_assessment_category b ON a.assessment_cat_id=b.assessment_cat_id WHERE (a.assessment_cat_id = '3')  ORDER BY a.assessment_cat_id ASC, a.assessment_sort ASC";
														...
														?>
														<th  align="center" bgcolor="#fcfdbf">
															<!--<a href="ajax/get_addrate.php?id=<?php echo $_rowSco_2['assessment_id'];?>&clid=<?php echo $cid;?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>&type=1&ctid=<?php echo $ctid;?>" data-toggle="modal" data-id="<?php echo $_rowSco_2['assessment_id'];?>" data-target="#AddRate" class="btn btn-sm blue" title="<?php echo $_rowSco_2['assessment_sort'];?>.&nbsp;<?php echo $_rowSco_2['assessment_name'];?>">
																<i class="fa fa-file-text-o"></i> </a>-->

                                                                <div><a  title="<?php echo $_rowSco_2['assessment_sort'];?>.&nbsp;<?php echo $_rowSco_2['assessment_name'];?>" class="badge badge-yellow p-1" data-toggle="modal" data-target="#AddRateB<?php echo $_rowSco_2['assessment_id'];?>" ><i class="icon-file-text3"></i></a></div>
                                                ...
                                                <tbody>
												<?php 
													$sql = "SELECT *  , b.student_no AS STNO FROM tb_assessment_classroom_detail a INNER JOIN tb_student b ON a.student_id = b.student_id WHERE a.a_classroom_id='{$cid}' AND a.a_classroom_detail_status='1' AND (b.student_no != '0' OR b.student_no != '') AND b.student_status='1' ORDER BY b.student_no ASC"; 
													$list = result_array($sql);
												?>
												<?php 
												...
												?>
                                                    <tr>
                                                        <td align="center"><?php echo $row['STNO'];?></td>
														...
														<?php
															$sqlSco1 = "SELECT * FROM tb_assessment a INNER JOIN tb_assessment_detail b ON a.assessment_id=b.assessment_id WHERE (a.assessment_cat_id ='2') AND b.a_classroom_id = '{$cid}' AND b.student_id='$row[student_id]' ORDER BY a.assessment_cat_id ASC, a.assessment_sort ASC";
														...
														?>
														<td align="center" bgcolor="#ccf4fd">
															<!--<?php echo $_rowSco1['assessment_detail_id'];?> - <?php echo $_rowSco1['score'];?>-->		
														...
														<?php 
															...
															$sqlSco2 = "SELECT * FROM tb_assessment a INNER JOIN tb_assessment_detail b ON a.assessment_id=b.assessment_id WHERE (a.assessment_cat_id ='3') AND b.a_classroom_id = '{$cid}' AND b.student_id='$row[student_id]' ORDER BY a.assessment_cat_id ASC, a.assessment_sort ASC";
														...
														?>
														<td  align="center" bgcolor="#fcfdbf">
															<!--<?php echo $_rowSco2['assessment_detail_id'];?> - <?php echo $_rowSco2['score'];?>-->
															<?php echo $_rowSco2['score'];?>
														
														</td>
														<?php 
															} 
															$sqlScoC = "SELECT * FROM tb_assessment a INNER JOIN tb_assessment_detail b ON a.assessment_id=b.assessment_id WHERE (a.assessment_cat_id ='5') AND b.a_classroom_id = '{$cid}' AND b.student_id='{$row['student_id']}'";
														...
														<!--<a href="ajax/get_addcomment.php?id=<?php echo $_rowScoC['assessment_detail_id'];?>&sid=<?php echo $_rowScoC['student_id'];?>&clid=<?php echo $_rowScoC['a_classroom_id'];?>&check_grade=<?php echo $check_grade;?>&check_term=<?php echo $check_term;?>" data-toggle="modal" data-id="<?php echo $_rowScoC['assessment_detail_id'];?>" data-target="#AddComment" class="btn btn-sm blue" title="<?php echo $_rowScoC['assessment_name'];?>">
    ...
    <?php
        ...
        foreach ($rowSco_1 as $_rowSco_1){ 
            ...
            ?>
                    ...
                    <div id="AddRateA<?php echo $_rowSco_1['assessment_id'];?>" class="modal fade" tabindex="-1">
...
<form name="form_AddRateA<?php echo $_rowSco_1['assessment_id'];?>" id="form_AddRateA<?php echo $_rowSco_1['assessment_id'];?>" method="post" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System();?>/js_code/assessment_show/assessment_show_process.php">
								...
								<div class="modal-footer">
									...
									<button type="submit" name="butAAddRateA<?php echo $_rowSco_1['assessment_id'];?>" id="butAAddRateA<?php echo $_rowSco_1['assessment_id'];?>" class="btn btn-info"> บันทึก</button>
								</div>
    ...
    <?php
            ...
            foreach ($rowSco_2 as $_rowSco_2){ 
                ...
                ?>
                    ...
                    <div id="AddRateB<?php echo $_rowSco_2['assessment_id'];?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header bg-info text-white">
									<h6 class="modal-title">ระดับคะแนน ห้องเรียน <?php echo $assessment_row['a_classroom_name']; ?> (<?php echo $_rowSco_2['assessment_sort'];?>.&nbsp;<?php echo $_rowSco_2['assessment_name'];?>)</h6>
									<button type="button" class="close" data-dismiss="modal">&times;</button>
								</div>
<form name="form_AddRateB<?php echo $_rowSco_2['assessment_id'];?>" id="form_AddRateB<?php echo $_rowSco_2['assessment_id'];?>" method="post" accept-charset="utf-8" action="<?php echo $RunLink->Call_Link_System();?>/js_code/assessment_show/assessment_show_process.php">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-link" data-dismiss="modal">ยกเลิก</button>
									<button type="submit" name="butAddRateB<?php echo $_rowSco_2['assessment_id'];?>" id="butAddRateB<?php echo $_rowSco_2['assessment_id'];?>" class="btn btn-info">บันทึก</button>
								</div>
    <input type="hidden" name="asid" id="asid" value="<?php echo $id; ?>">
    <input type="hidden" name="clid" id="clid" value="<?php echo $clid; ?>">
	<input type="hidden" name="check_grade" id="check_grade" value="<?php echo $check_grade; ?>">
                        ...
                        var action = "create_Comment";
                            if(action=="create_Comment"){
                                ...
                                if(txtdetail!=""){
                                    ...
                                    $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/assessment_show/assessment_show_process.php",{
                                        action:action,
                                        assid:assid,
                                        sid:sid,
                                        clid:clid,
                                           ...
                                           if(test_process==="no_error"){
                                                ...
                                                swalInitAddCommentData.fire({
                                                    ...
                                                    if (result.dismiss === Swal.DismissReason.timer) {
                                                        document.location = '<?php echo $RunLink->Call_Link_System(); ?>/?modules=assessment_show&id='+btoa(clid)+'&check_grade='+btoa(check_grade)+'&check_term='+btoa(check_term);
                                                    } else {}
                                                });
