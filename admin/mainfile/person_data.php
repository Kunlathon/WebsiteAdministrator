...
if ((preg_match("/person_data.php/", $_SERVER['PHP_SELF']))) {
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="?modules=person_data" class="breadcrumb-item"> บุคลากรทั้งหมด</a>

                        <a href="#" class="breadcrumb-item"> ข้อมูลบุคลากรทั้งหมด</a>
        ...
        <div class="content">
                        ...
                        <div class="col-<?php echo $grid; ?>-12">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <div>
                                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data';" class="btn btn-outline-success" value="">รายการ</button>
                                        </div>
                                    </td>
                                    <td>

                                        <div>
                                            <form name="form_show" id="form_show" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=profile&teacher_key=<?php echo base64_encode(@$fe_row['teacher_id']); ?>">
                                    ...
                                    <td>
                                        <div>
                                            <form name="update_ta" id="update_ta" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=form_edit&teacher_key=<?php echo base64_encode(@$fe_row['teacher_id']); ?>">
                                    ...
                                    <td>
                                        <div>
                                            <form name="update_picture" id="update_picture" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=change_picture&teacher_key=<?php echo base64_encode(@$fe_row['teacher_id']); ?>">
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                <div class="col-<?php echo $grid; ?>-6">ฟอร์มข้อมูลบุคลากร</div>
                                <div class="col-<?php echo $grid; ?>-6" align="right">
                                    <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                    <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลบุคลากร</button>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-<?php echo $grid; ?>-12">
                                        <form name="person_data_form_add" id="person_data_form_add" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-<?php echo $grid; ?>-12">
                                                    <fieldset class="mb-3">
                            ...
                            <div class="col-<?php echo $grid; ?>-12">
                                <fieldset class="mb-3">
                                    <div class="form-group row">
                                        <label class="col-form-label col-<?php echo $grid; ?>-3">ประเภทบุคลากร</label>
                                        <div class="col-<?php echo $grid; ?>-9">
                                            <select class="form-control select" name="ttype" id="ttype" data-placeholder="เลือกประเภทบุคลากร..." required="required">
                                                    <option></option>
                                                <optgroup label="ประเภทบุคลากร">
                                                    <option value="1">บุคลากรไทย</option>
                                                    <option value="2">บุคลากรต่างประเทศ</option>
                                                </optgroup>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-<?php echo $grid; ?>-12">
                                <fieldset class="mb-3">
                                    <div class="form-group row">
                                        <label class="col-form-label col-<?php echo $grid; ?>-3">บุคลากรประจำชั้น</label>
                                        <div class="col-<?php echo $grid; ?>-9">
                                            <select class="form-control select" name="tclass" id="tclass" data-placeholder="เลือกบุคลากรประจำชั้น..." required="required">
                                                    <option></option>
                                                <optgroup label="บุคลากรประจำชั้น">
                            ...
                            <div class="col-<?php echo $grid; ?>-12">
                                <fieldset class="mb-3">
                                    <div class="form-group row">
                                        <label class="col-form-label col-<?php echo $grid; ?>-3">บุคลากรประจำรายวิชา</label>
                                        <div class="col-<?php echo $grid; ?>-9">
                                            <select class="form-control select" name="tteach" id="tteach" data-placeholder="เลือกบุคลากรประจำรายวิชา..." required="required">
                                                    <option></option>
                                                <optgroup label="บุคลากรประจำรายวิชา">
                                                    <option value="1">เป็น</option>
                                                    <option value="0">ไม่เป็น</option>
                                                </optgroup>
                                            </select>
                                        ...
                                        <div class="col-<?php echo $grid; ?>-9">
                                            ...
                                            <div class="row">
                                                <div class="col-<?php echo $grid; ?>-12">
                                                    <fieldset class="mb-3">
                                                        <div class="form-group row">
                                                            <button type="button" name="Add_person_data" id="Add_person_data" class="btn btn-info" value="">บันทึก</button>&nbsp;
            ...
            <?php } elseif (($manage == "form_edit")) { ?>
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid; ?>-12">
                            <div class="card border border-purple">
                                <div class="card-header header-elements-inline bg-info text-white">
                                    <div class="col-<?php echo $grid; ?>-6">ฟอร์มแก้ไขข้อมูลบุคลากร</div>
                                    <div class="col-<?php echo $grid; ?>-6" align="right">
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลบุคลากร</button>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-<?php echo $grid; ?>-12">
                                            <form name="person_data_form_edit" id="person_data_form_edit" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-<?php echo $grid; ?>-12">
                                                        <fieldset class="mb-3">
                                                            <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-<?php echo $grid; ?>-9">
                                            <select class="form-control select" name="ttype" id="ttype" data-placeholder="เลือกประเภทบุคลากร..." required="required">
                                                    <option></option>
                                                <optgroup label="ประเภทบุคลากร">
                                                    <option <?php echo @$row['teacher_type'] == 1 ? "selected" : ""; ?> value="1">บุคลากรไทย</option>
                                                    <option <?php echo @$row['teacher_type'] == 2 ? "selected" : ""; ?> value="2">บุคลากรต่างประเทศ</option>
                                                </optgroup>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <div id="password-edit">
                                                ...
                                                <div class="row">
                                                    <div class="col-<?php echo $grid; ?>-12">
                                                        <fieldset class="mb-3">
                                                            <div class="form-group row">
                                                                <button type="button" name="Edit_person_data" id="Edit_person_data" class="btn btn-info" value="<?php echo @$row['teacher_id']; ?>">บันทึก</button>&nbsp;
                                                                <button type="reset" class="btn btn-danger">ยกเลิก</button>
                ...
                <?php   } else {
                    ...
                    exit("<script>window.location='$linkcopy/?modules=person_data';</script>");
                }
                ?>
                <!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
                        ...
                        <div class="col-<?php echo $grid; ?>-12">
                            <div class="card border border-purple">
                                <div class="card-header header-elements-inline bg-info text-white">
                                    ...
                                    <div class="col-<?php echo $grid; ?>-6" align="right">
                                        <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                        <!-- <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลครู</button> -->
                                    </div>
                                </div>
                    ...
                    <?php   }  ?>                                  
                                        ...
                                        <div class="col-<?php echo $grid; ?>-6">
<form name="form_change_picture" id="form_change_picture" enctype="multipart/form-data" action="<?php echo $RunLink->Call_Link_System();?>/js_code/person_data/person_data_process.php" method="post">
                        ...
                        <div class="col-<?php echo $grid; ?>-12">
                            <div class="toast" style="opacity: 1; max-width: none;">
                                ...
                                <div class="toast-body">
                                    <form name="person_data_password" id="person_data_password" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-<?php echo $grid; ?>-12">
                                                <fieldset class="mb-3">
                                                    <div class="form-group row">
                                        ...
                                        <div class="row">
                                            <div class="col-<?php echo $grid; ?>-12">
                                                <fieldset class="mb-3" style="float: right">
                                                    <button type="button" name="password_person_data" id="password_person_data" class="btn btn-info" value="<?php echo @$row['teacher_id']; ?>">บันทึก</button>&nbsp;
            ...
            <?php } else { ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="card border border-purple">
                            <div class="card-header header-elements-inline bg-info text-white">
                                <div class="col-<?php echo $grid; ?>-6">ตารางข้อมูลคุณบุคลากรทั้งหมด</div>
                                <div class="col-<?php echo $grid; ?>-6" align="right">
                                    <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                    <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=form_add';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลบุคลากร</button>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-<?php echo $grid; ?>-12">
                                        <form name="person_data_read" id="person_data_read" method="post" accept-charset="utf-8">
                                            <div class="table-responsive">
                                                <table class="table table-bordered datatable-button-html5-columns-STD">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT * FROM `tb_teacher` WHERE `teacher_status`='1' AND `teacher_type`='3' AND `teacher_work`='1' ORDER BY `teacher_section_id` ASC, `teacher_name` ASC";
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="width: 18%;">
                                                                    <div align="center">
                                                                        <button type="button" name="" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=password&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>';" class="btn btn-outline-warning btn-sm" data-popup="tooltip" title="เปลี่ยนรหัสผ่าน" data-placement="bottom" value=""><i class="icon-key"></i></button>

                                                                        <button type="button" name="Showperson_data" id="Showperson_data" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=profile&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>';" class="btn btn-outline-primary btn-sm" data-popup="tooltip" title="รายละเอียด" data-placement="bottom" value="<?php echo @$row['teacher_id']; ?>"><i class="icon-search4"></i></button>

                                                                        <button type="button" name="Upperson_data" id="Upperson_data" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=person_data&manage=form_edit&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>';" class="btn btn-outline-secondary btn-sm" data-popup="tooltip" title="แก้ไข" data-placement="bottom" value="<?php echo @$row['teacher_id']; ?>"><i class="icon-pen"></i></button>
