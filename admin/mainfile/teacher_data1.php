...
if ((preg_match("/teacher_data1.php/", $_SERVER['PHP_SELF']))) {
    ...
    if ((check_session("admin_status_aba") == '1') || (check_session("admin_status_aba") == '2') || (check_session("admin_status_aba") == '3') || (check_session("admin_status_aba") == '4') || (check_session("admin_status_aba") == '5')) { ?>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="?modules=teacher_data1" class="breadcrumb-item"> ครูไทยทั้งหมด</a>

                        <a href="#" class="breadcrumb-item"> ข้อมูลครูไทยทั้งหมด</a>
        ...
        <div class="content">
                        ...
                        <div class="col-<?php echo $grid; ?>-12">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <div>
                                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($id); ?>';" class="btn btn-outline-success" value="">รายการ</button>
                                        </div>
                                    </td>
                                    <td>

                                        <div>
                                            <form name="form_show" id="form_show" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode('profile'); ?>&teacher_key=<?php echo base64_encode(@$fe_row['teacher_id']); ?>&id=<?php echo base64_encode($id); ?>">
                                    ...
                                    <td>
                                        <div>
                                            <form name="update_ta" id="update_ta" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($id); ?>&manage=form_edit<?php echo $id; ?>&teacher_key=<?php echo base64_encode(@$fe_row['teacher_id']); ?>">
                                    ...
                                    <td>
                                        <div>
                                            <form name="img_ta" id="img_ta" method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($id); ?>&manage=change_picture<?php echo $id; ?>&teacher_key=<?php echo base64_encode(@$fe_row['teacher_id']); ?>">
            ...
            <?php   } else { ?>
                ...
                <div class="row">
                    <div class="col-<?php echo $grid; ?>-12">
                        <div class="btn-group">
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode(1); ?>';" class="btn btn-outline-secondary">ครูรายวิชา</button>
                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode(2); ?>';" class="btn btn-outline-success">ครูประจำชั้น</button>
                        </div>
                    </div>
                </div><br>
                ...
                if (($list == "1")) { ?>
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid; ?>-12">
                            <h4>ข้อมูลครูไทย <?php echo $list_row_txt[0]; ?></h4>
                        </div>
                    </div><br>
                                ...
                                <div class="card border border-purple">
                                    <div class="card-header header-elements-inline bg-info text-white">
                                        ...
                                        <div class="col-<?php echo $grid; ?>-6" align="right">
                                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[0]); ?>';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[0]); ?>&manage=form_add1';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลครู</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-<?php echo $grid; ?>-12">
                                                <form name="teacher_data1_form_add" id="teacher_data1_form_add" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-<?php echo $grid; ?>-12">
                                                            <fieldset class="mb-3">
                                            ...
                                            <div id="status_work-null"></div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-<?php echo $grid; ?>-12">
                                                            <fieldset class="mb-3">
                                                                <div class="form-group row">
                                                                    <button type="button" name="Add_teacher_data1" id="Add_teacher_data1" class="btn btn-info" value="">บันทึก</button>&nbsp;
                    ...
                    <?php } elseif (($manage == "form_edit1")) { ?>
                                ...
                                <div class="col-<?php echo $grid; ?>-12">
                                    <div class="card border border-purple">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-<?php echo $grid; ?>-12">
                                                    <form name="teacher_data1_form_edit" id="teacher_data1_form_edit" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col-<?php echo $grid; ?>-12">
                                                                <fieldset class="mb-3">
                                                                    <div class="form-group row">
                        ...
                        <?php   } else {
                            ...
                            exit("<script>window.location='$linkcopy/?modules=teacher_data1';</script>");
                        }
                        ?>
                        <!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
                    <?php }elseif(($manage == "change_picture1")){ ?>
                        ...
                        ?>
                            ...
                            <?php   }  ?>                                  
                                                ...
                                                <div class="col-<?php echo $grid; ?>-6">
        <form name="form_change_picture" id="form_change_picture" enctype="multipart/form-data" action="<?php echo $RunLink->Call_Link_System();?>/js_code/teacher_data1/teacher_data1_process.php" method="post">
        ...
        <input type="hidden" name="code_list" id="code_list" value="<?php echo base64_encode($list_row_id[0]); ?>">
                                ...
                                <div class="col-<?php echo $grid; ?>-12">
                                    <div class="toast" style="opacity: 1; max-width: none;">
                                        ...
                                        <div class="toast-body">
                                            <form name="teacher_data1_password" id="teacher_data1_password" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-<?php echo $grid; ?>-12">
                                                        <fieldset class="mb-3">
                                                            <div class="form-group row">
                                                ...
                                                <div class="row">
                                                    <div class="col-<?php echo $grid; ?>-12">
                                                        <fieldset class="mb-3" style="float: right">
                                                            <button type="button" name="password_teacher_data1" id="password_teacher_data1" class="btn btn-info">บันทึก</button>&nbsp;
                            ...
                            <div class="col-<?php echo $grid; ?>-12">
                                <div class="card border border-purple">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-<?php echo $grid; ?>-12">
                                                <form name="teacher_data1_read" id="teacher_data1_read" method="post" accept-charset="utf-8">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 18%;">
                                                                            <div align="center">
                                                                                <button type="button" name="" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[0]); ?>&manage=password1&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>';" class="btn btn-outline-warning btn-sm" data-popup="tooltip" title="เปลี่ยนรหัสผ่าน" data-placement="bottom" value=""><i class="icon-key"></i></button>
                                                                                <button type="button" name="Showteacher_data1" id="Showteacher_data1" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode('profile'); ?>&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>&id=<?php echo base64_encode($list_row_id[0]); ?>';" class="btn btn-outline-primary btn-sm" data-popup="tooltip" title="รายละเอียด" data-placement="bottom" value="<?php echo @$row['teacher_id']; ?>"><i class="icon-search4"></i></button>


                                                                                <button type="button" name="Upteacher_data1" id="Upteacher_data1" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[0]); ?>&manage=form_edit1&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>';" class="btn btn-outline-secondary btn-sm" data-popup="tooltip" title="แก้ไข" data-placement="bottom" value="<?php echo @$row['teacher_id']; ?>"><i class="icon-pen"></i></button>
                                                                                                ...
                                                                                                var _componentABA_DeleteTeacherData1 = function() {
                                                                                                    ...
                                                                                                    $('#delete_<?php echo @$row['teacher_id']; ?>').on('click', function() {
                                                                                                        ...
                                                                                                        if (action == "") {
                                                                                                            ...
                                                                                                            if (teacher_key != "") {
                                                                                                                $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/teacher_data1/teacher_data1_process.php", {
                                                                                                                    action: action,
                                                                                                                    table: table,
                                                                                                                    ff: ff,
                                                                                                                    ...
                                                                                                                    if (process_add.trim() === "no_error") {
                                                                                                                        ...
                                                                                                                        swalInitDeleteTeacherData1.fire({
                                                                                                                            ...
                                                                                                                            if (result.dismiss === Swal.DismissReason.timer) {
                                                                                                                                document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[0]); ?>";
                                                                                                                            } else {}
                                                                                                                        });
                ...
                <?php   } elseif (($list == "2")) { ?>
                    ...
                    <div class="row">
                        <div class="col-<?php echo $grid; ?>-12">
                            <h4>ข้อมูลครูไทย <?php echo $list_row_txt[1]; ?></h4>
                        </div>
                    </div><br>
                            ...
                            <div class="col-<?php echo $grid; ?>-12">
                                <div class="card border border-purple">
                                    <div class="card-header header-elements-inline bg-info text-white">
                                        <div class="col-<?php echo $grid; ?>-6">ฟอร์มข้อมูลครู</div>
                                        <div class="col-<?php echo $grid; ?>-6" align="right">
                                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[1]); ?>';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-list-unordered"></i> รายการ</button>
                                            <button type="button" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[1]); ?>&manage=form_add2';" class="btn btn-secondary btn-sm" style="align: right;"><i class="icon-plus3"></i> เพิ่มข้อมูลครู</button>
                                        </div>
                                    </div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 18%;">
                                                                            <div align="right">
                                                                                <button type="button" name="" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[1]); ?>&manage=password2&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>';" class="btn btn-outline-warning btn-sm" data-popup="tooltip" title="เปลี่ยนรหัสผ่าน" data-placement="bottom" value=""><i class="icon-key"></i></button>

                                                                                <button type="button" name="Showteacher_data2" id="Showteacher_data2" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode('profile'); ?>&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>&id=<?php echo base64_encode($list_row_id[1]); ?>';" class="btn btn-outline-primary btn-sm" data-popup="tooltip" title="รายละเอียด" data-placement="bottom" value="<?php echo @$row['teacher_id']; ?>"><i class="icon-search4"></i></button>

                                                                                <button type="button" name="Upteacher_data2" id="Upteacher_data2" onclick="location.href='<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[1]); ?>&manage=form_edit2&teacher_key=<?php echo base64_encode(@$row['teacher_id']); ?>';" class="btn btn-outline-secondary btn-sm" data-popup="tooltip" title="แก้ไข" data-placement="bottom" value="<?php echo @$row['teacher_id']; ?>"><i class="icon-pen"></i></button>
                                                                                <button type="button" name="modal_theme_success_Delete<?php echo @$row['teacher_id']; ?>" data-toggle="modal" data-target="#modal_theme_success_Delete<?php echo @$row['teacher_id']; ?>" class="btn btn-outline-danger btn-sm" data-popup="tooltip" title="ลบ" data-placement="bottom"><i class="icon-bin"></i></button>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                                                                ...
                                                                                                                $.post("<?php echo $RunLink->Call_Link_System(); ?>/js_code/teacher_data1/teacher_data1_process.php", {
                                                                                                                    ...
                                                                                                                    if (process_add.trim() === "no_error") {
                                                                                                                        ...
                                                                                                                        swalInitDeleteTeacherData2.fire({
                                                                                                                            ...
                                                                                                                            if (result.dismiss === Swal.DismissReason.timer) {
                                                                                                                                document.location = "<?php echo $RunLink->Call_Link_System(); ?>/?modules=teacher_data1&list=<?php echo base64_encode($list_row_id[1]); ?>";
                                                                                                                            } else {}
                                                                                                                        });
