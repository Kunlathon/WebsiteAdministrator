...
?>
    <?php
        if((preg_match("/report_score_back.php/", $_SERVER['PHP_SELF']))){
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="<?php echo $RunLink->Call_Link_System();?>/?modules=report_score_back" class="breadcrumb-item">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-<?php echo $grid;?>-12">
                <div style="font-size: 20px;"> แบบรายงานผลคะแนน (ย้อนหลัง)</div>
            </div>
        </div>
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
                        <div class="col-<?php echo $grid; ?>-4">
<form name="list_class<?php echo $count_color;?>"  method="post" action="<?php echo $RunLink->Call_Link_System(); ?>/?modules=report_score_back">
