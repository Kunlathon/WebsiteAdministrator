...
error_reporting(E_ALL ^ E_NOTICE);
    if((preg_match("/assessment_data_th.php/", $_SERVER['PHP_SELF']))) {
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="#" class="breadcrumb-item"> ประเมินนิสิต(ครูไทย)</a>
        ...
        <script>
            $(document).ready(function(){
                $('#button_class<?php echo $class_Print["grade_id"];?>').on('click',function(){
                    ...
                    var manage="read";
                    $.post("<?php echo $RunLink->Call_Link_System();?>/js_code/assessment_data_th/assessment_data_th_show.php",{
                        class_id:cp_class,
