...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12 control-label" align="center">
                            ...
                            <div><strong>การประเมินครั้งที่ 1 ภาคเรียนที่ <?php echo $term1;?> ปีการศึกษา <?php echo $year1;?> / 1<sup>st</sup> Assessment Semester <?php echo $term1;?> Academic Year <?php echo $year2;?></strong></div>
                        ...
                        <div claas="col-md-12">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            ?>
                                                    ...
                                                    <td align="center"><?php echo $score2_show; ?></td>
                                                    <?php 
                                                        $score1 = $score1;
                                                        $score2 = $score2;
