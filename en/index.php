...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Language Center MCU Chaing Mai Campus"/>

    <meta property="og:image:width" content="1280">
    <meta property="og:image:height" content="640">
    <meta property="og:site_name" content="Language Center MCU Chaing Mai Campus">
    <meta property="og:type" content="object">
    <meta property="og:title" content="Language Center MCU Chaing Mai Campus">
    <meta property="og:description" content="Language Center MCU Chaing Mai Campus">

<?php 
  if($modules=="news-detail"){
...
?>
	...
	<meta property="og:title" content="<?php echo $rowTravel['news_topic_en']; ?>"/>
	<meta property="og:description" content="<?php echo $rowTravel['news_topic_en']; ?>" />
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item" href="?modules=resolution">
                        Resolution & Vision & Mission & Objectives
                      </a>
