                                                        ...
                                                        <div class="page-header d=print-none">
                                                            <div class="container-xl">
                                                                <div class="row g-2 alogn-items-center">
                                                                    <div class="col-md-12">
                                                                        <div class="row g-2">
                                                                            <div class="page-title" style="font-size: 20px;">News Detail</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col-md-12">
                                                                        <p align="left">Latest Update&nbsp;<?php echo  date_full_en($data_news_row['news_post_date']); ?></p>
                                                                        <p>

                                                                            <i class="fa fa-user"></i> Visitors <?php echo $pageview; ?> &nbsp;
                                                                            <?php
                                                                            $sqlCat = "SELECT * FROM tb_news_category WHERE news_category_id = '$data_news_row[news_category_id]'";
                                                                            $rowCat = row_array($sqlCat);
                                                                                if((is_array($rowCat ) and count($rowCat ))){
                                                                                    $txt_category_name=$rowCat['news_category_name_en'];
                                                                                }else{
                                                                                    $txt_category_name=null;
                                                                                }

                                                                            ?>

                                                                            <i class="fa fa-comments"></i> Category <?php echo $txt_category_name; ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="alert alert-success" role="alert">
                                                                                <div><a href="?modules=news_detail&id=<?php echo $Statistics_New_Row['news_id']; ?>"><?php echo $Statistics_New_Row["news_topic_en"] . " (" . $Statistics_New_Row["news_pageview"] . ")"; ?></a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
