              ...
              <div class="card-body ">
                <div class="row g-4">
                  ...
                  <div class="col-12 markdown">
					...
					<?php   } else { ?>
                            <p><div align="center"><img src="../dist/information/<?php echo $rowHis['information_image'];?>" class="img-thumbnail" alt="<?php echo $rowHis['information_topic_en'];?>" style="width:100%;"></div></p>
