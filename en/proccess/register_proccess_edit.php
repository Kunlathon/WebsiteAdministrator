    ...
    $course_id=filter_input(INPUT_POST,'course');
        ...
        if(($_FILES["img1"]["name"]!=null)){
            ...
            $register_data = array(
                ...
                "user_address_no_now"=>$address2,
                "user_address_moo_now"=>$moo2,
                "user_address_soi_now"=>$soi2,
                "user_address_road_now"=>$road2,
                "user_address_subdistrict_now"=>$subdistrict2,
                "user_address_district_now"=>$district2,
                "user_address_province_now"=>$province2,
                "user_address_citycode_now"=>$citycode2,
                "user_tel"=>$tel,
                "user_email"=>$email,
                "user_height"=>$height,
                "user_weight"=>$weight,
